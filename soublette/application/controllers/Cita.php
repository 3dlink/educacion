<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
  ...
  class Resumen extends CI_Controller {
    ...
    public function index()
    {
      ...
      $this->pdf->Ln(1);
      $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252',$escuela->direccion),0,50,'L');
      $this->pdf->SetFont('Arial', 'B', 8);
      $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252',$escuela->telefono),0,50,'L');
      $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252',$escuela->correo_electronico),0,50,'L');
