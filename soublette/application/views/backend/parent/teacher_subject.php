    ...
    <div class="col-md-12">
        ...
        <div class="tab-content">
                        ...
                        <tbody>
                            <?php foreach($resut_teachers as $row):?>
                                <tr>
                                    ...
                                    <td style="text-align: center;"><?php echo $this->crud_model->get_subject_name_by_id( $row['id_subject'] ); ?></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                <li>
                                                    <a href="#" onclick="delete_modal('<?php echo base_url().$this->session->userdata('login_type');?>/teacher_subject/anular/<?php echo $row['teacher_id']; ?>/<?php echo $id_nivel_educativo; ?>');">
            ...
            <div class="tab-pane box " id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url().'admin/teacher_subject/asignar/'.$id_nivel_educativo , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
