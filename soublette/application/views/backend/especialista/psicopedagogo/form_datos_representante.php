    ...
    <div class="box-content">
        <form id="form-datos-representante" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group" id="div-select-tipo-parentesco" style="display:none">
                ...
                <div class="col-sm-6">
                  <select class="form-control" id="repreParentescoOtro" name="OtroParentescoConElAlumno">
                    ...
                    <option value="ABUELA">Abueloa</option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" required minlength="7" class="form-control" id="repreCedula" name="CedulaDeIdentidadDelRepresentante" placeholder="Cédula de identidad del representante">
                </div>
            </div>
            <div class="form-group">
...
<!--             <div class="form-group">
                <label for="field-1" class="col-sm-4 control-label">Tiene la misma dirección de residencia que el alumno<span style="color:red"> *</span></label>
                <div class="col-sm-6">
                    <label><input type="radio" required class="form-control repreMismaDireAlu" name="RepresentanteMismaDireAlu" value="1">Sí</label>
                    <label><input type="radio" class="form-control repreMismaDireAlu" name="RepresentanteMismaDireAlu" value="0">No</label>
                </div>
            </div> -->
            ...
            <div id="sectorMunicipioChacaoRepre" class="form-group" style="display: none">
                ...
                <div class="col-sm-6">
                      <select class="form-control" id="select-sector-municipio" name="UrbanizacionOSectorDondeResideElRepresentante" >
                        <option value="0" selected="selected" disabled="disabled">Seleccione...</option>
            ...
            <div class="form-group depenRepreMismaResi">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control onlyNumbers" minlength="1" id="reprePrimerNombre" name="PisoDondeResideElRepresentante" placeholder="Piso donde reside el representante">
                </div>
            </div>
            <div class="form-group depenRepreMismaResi">
                <label for="field-1" class="col-sm-4 control-label">Número o apartamento donde reside<span style="color:red"> *</span></label>
                <div class="col-sm-6">
                    <input type="text" required class="form-control onlyNumbers" minlength="1" id="repreApartamento" name="NumeroOApartamentoDondeResideElRepresentante" placeholder="Número o apartamento donde residem el representante">
                </div>
            </div>
            <div class="form-group depenRepreMismaResi">
            ...
            <div class="form-group repre-trabajador" style="display:none">
                ...
                <div class="col-sm-6">
                    <input type="text" minlength="2" class="form-control" id="repreRelacionLaboral" name="TipoRelacionLaboralRepresentante" placeholder="Profesión u ocupación del representante">
                </div>
            </div>
            <div class="form-group repre-trabajador" style="display:none">
                <label for="field-1" class="col-sm-4 control-label">Tipo de relacion laboral</label>
                <div class="col-sm-6">
                    <label><input type="radio" class="form-control" name="TipoDeRelacionLaboralDelRepresentante" value="TRABAJADORINFORMAL">Trabajador Informal</label>
                    <label><input type="radio" required class="form-control" name="TipoDeRelacionLaboralDelRepresentante" value="TRABAJADORINDEPENEDIENTE">Trabajador Independiente</label>
                    <label><input type="radio" class="form-control" name="TipoDeRelacionLaboralDelRepresentante" value="TRABAJADORDEPENDIENTE">Trabajador Dependiente</label>
                </div>
            </div>
            <div class="form-group repre-trabajador" style="display:none">
                ...
                <div class="col-sm-6">
                  <select class="form-control"  id="select-ingreso-mensualRepresentante" name="IngresoMensualDelRepresentante" >
                    ...
                    <?php foreach ($nivel_ingreso as $nivel){ ?>
                        <option value="<?php $nivel['id_nivel_ingreso_censo']?>" class="oculto"> <?php echo $nivel['valor']?></option>
                    <?php } ?>
                  </select>
                </div>
            </div>
            ...
            <div class="form-group repre-trabajador" style="display:none">
                ...
                <div class="col-sm-6">
                    <label><input type="radio" class="form-control" name="TipoDeJornadaLaboralDelRepresentante" value="TIEMPOCOMPLETO">Tiempo completo</label>
                    <label><input type="radio" required class="form-control" name="TipoDeJornadaLaboralDelRepresentante" value="MEDIOTIEMPO">Medio Tiempo</label>
            ...
            <div class="form-group depen-repre-diversidad" style="display:none">
                ...
                <div class="col-sm-6">
                    <div class="checkbox">
                      <label><input type="checkbox" required name="RepreDiversidadMotora" value="1">Motora</label>
                    </div>
                    ...
                    <div class="checkbox">
                      <label><input type="checkbox" required name="RepreDiversidadLenguaje" value="1">De lenguaje</label>
                    </div>
