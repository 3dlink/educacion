...
<!--             <div class="form-group depen-madre-vive" style="display:none">
                <label for="field-1" class="col-sm-4 control-label">La madre vive en el mismo lugar de residencia que el alumno</label>
                <div class="col-sm-6">
                    <label><input type="radio" class="form-control radio-madreMismaResiAlu" name="MadreMismaResiAlu" value="1">Sí</label>
                    <label><input type="radio" class="form-control radio-madreMismaResiAlu" name="MadreMismaResiAlu" value="0">No</label>
                </div>
            </div> -->
            ...
            <div class="form-group only-hide-madre depen-madre-vive" style="display:none">
                ...
                <div class="col-sm-6">
                  <input type="text" minlength="1" class="form-control onlyNumbers" id="apartamentoMadre" name="NumeroOApartamentoDondeResideLaMadre" placeholder="Número o apartamento donde reside la madre">
                </div>
            </div>
            <div class="form-group only-hide-madre depen-madre-vive" style="display:none">
            ...
            <div class="form-group only-hide-madre depen-madre-trabaja" style="display:none">
                ...
                <div class="col-sm-6">
                    ...
                    <label><input type="radio" required class="form-control" name="TipoDeJornadaLaboralMadre" value="MEDIOTIEMPO">Medio Tiempo</label>
            ...
            <div class="form-group repre-trabajador" style="display:none">
                ...
                <div class="col-sm-6">
                    ...
                    <label><input type="radio" required class="form-control" name="TipoDeRelacionLaboralDeLaMadre" value="TRABAJADORINDEPENEDIENTE">Trabajador Independiente</label>
