...
<!--             <div class="form-group depen-padre-vive" style="display:none">
                <label for="field-1" class="col-sm-4 control-label">El padre vive en el mismo lugar de residencia que el alumno</label>
                <div class="col-sm-6">
                    <label><input type="radio" required class="form-control radio-padreMismaResiAlu" name="ElPadreViveEnElMismoLugarDeResidenciaDelAlumno" value="1">Sí</label>
                    <label><input type="radio" class="form-control radio-padreMismaResiAlu" name="ElPadreViveEnElMismoLugarDeResidenciaDelAlumno" value="0">No</label>
                </div>
            </div> -->
            ...
            <div class="form-group only-hide-padre depen-padre-vive" style="display:none">
                ...
                <div class="col-sm-6">
                  <input type="text" required minlength="2" class="form-control onlyNumbers" id="padreApartamento" name="NumeroDeCasaOApartamentoDondeResideElPadre" placeholder="Número o apartamento donde reside el padre">
                </div>
            </div>
            <div class="form-group only-hide-padre depen-padre-vive" style="display:none">
