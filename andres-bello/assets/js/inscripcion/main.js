...
function AjaxImagen(link,datosForm,tipo,sincronizacion,funcion_respuesta) {
    tipo = tipo || "POST";
...
function AjaxReport(link,datosForm,enviarReporte,tipo,sincronizacion,funcion_respuesta) {
    tipo = tipo || "POST";
    var url_base = '';
    ...
    var windows_certificate = window.open(url_base+'/../student_certificate/'+datosForm, '_blank');
    windows_certificate.focus();

    jQuery.ajax({
        url: url_base+'/'+link,
        type: tipo,
        data: {id_inscripcion: datosForm, enviar: enviarReporte},
        dataType: "text",
        success: function(response) {
            funcion_respuesta(response);
        },
...
function AjaxReportEdit(link,datosForm,enviarReporte,tipo,sincronizacion,funcion_respuesta) {
    tipo = tipo || "POST";
    var url_base = '';
...
function AjaxReportEmpty(link,datosForm,enviarReporte,tipo,sincronizacion,funcion_respuesta) {
    tipo = tipo || "POST";
    var url_base = '';
