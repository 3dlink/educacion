...
function AjaxEditarCenso(link,datosForm,tipo,sincronizacion,funcion_respuesta) {
    ...
    jQuery.ajax({
        url: 'http://localhost/andres-bello/admin/'+link,
        type: tipo,
        data: datosForm,
        success: function(response) {
            funcion_respuesta(response);
...
jQuery( document ).ready(function() {
    ...
    jQuery('#linkEnviarConstancia').click(function(e){
        var data = jQuery('#form-constancias').serialize()+ '&' ;

        jQuery('#linkEnviarConstancia').prop("disabled",true);
        Ajax('../../../EnviarConstancia',data,'POST',true,function(response){
            mostrarModal("Éxito", "Constancia enviada con exito.", 'type-primary',
                    [{
                        label: 'Aceptar',
                        cssClass: 'btn-success',
                        action: function(dialogItself){
            ...
            jQuery('#linkEnviarConstancia').prop("disabled",false);
        });
    });

    jQuery('#linkEnviarConstanciaAsistencia').click(function(e){
        var data = jQuery('#form-constancias').serialize()+ '&' ;

        jQuery('#linkEnviarConstanciaAsistencia').prop("disabled",true);
        Ajax('../../../EnviarConstancia',data,'POST',true,function(response){
            mostrarModal("Éxito", "Constancia enviada con exito.", 'type-primary',
                    [{
                        label: 'Aceptar',
            ...
            jQuery('#linkEnviarConstanciaAsistencia').prop("disabled",false);
        });
    });

    jQuery('#linkEnviarConstanciaTramites').click(function(e){
        var data = jQuery('#form-constancias').serialize()+ '&' ;

        jQuery('#linkEnviarConstanciaTramites').prop("disabled",true);
        Ajax('../../../EnviarConstancia',data,'POST',true,function(response){
            mostrarModal("Éxito", "Constancia enviada con exito.", 'type-primary',
                    [{
                        label: 'Aceptar',
            ...
            jQuery('#linkEnviarConstanciaTramites').prop("disabled",false);
        });
    });

    jQuery('#linkEnviarConstanciaConvovatoria').click(function(e){
        var data = jQuery('#form-constancias').serialize()+ '&' ;

        jQuery('#linkEnviarConstanciaConvovatoria').prop("disabled",true);
        Ajax('../../../EnviarConstancia',data,'POST',true,function(response){
            mostrarModal("Éxito", "Constancia enviada con exito.", 'type-primary',
                    [{
                        label: 'Aceptar',
            ...
            jQuery('#linkEnviarConstanciaConvovatoria').prop("disabled",false);
        });
    });
    
    jQuery('#linkEnviarCarnet').click(function(e){
        var data = jQuery('#form-carnet').serialize()+ '&' ;

        jQuery('#linkEnviarCarnet').prop("disabled",true);
        Ajax('../../../EnviarCarnet',data,'POST',true,function(response){
            mostrarModal("Éxito", "Carnet enviado con exito.", 'type-primary',
                    [{
                        label: 'Aceptar',
                        cssClass: 'btn-success',
                        action: function(dialogItself){
            ...
            jQuery('#linkEnviarCarnet').prop("disabled",false);
        });
    });
