        ...
        <form id="form-datos-saludalu" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="col-sm-6" style="padding: 0px ! important;">
                        <div class="col-sm-6" style="padding: 0px ! important;">
                            <input type="number" required minlength="1" maxlength="1" min="0" max="2" class="form-control" id="estatura_metros" name="estatura_metros" placeholder="" value="0">
                        </div>
                        <label for="field-1" class="col-sm-4 control-label" style="color:gray; text-align: left !important;">metro(s)</label>
                    </div>
                    <div class="col-sm-6" style="padding: 0px ! important;">
                        <div class="col-sm-6" style="padding: 0px ! important;">
                            <input type="number" required minlength="1" maxlength="2" min="0" max="99" class="form-control" id="estatura_centimetros" name="estatura_centimetros" placeholder="" value="0">
                        </div>
                        <label for="field-1" class="col-sm-4 control-label" style="color:gray; text-align: left !important;">centímetro(s)</label>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="col-sm-6" style="padding: 0px ! important;">
                        <div class="col-sm-6" style="padding: 0px ! important;">
                            <input type="number" required minlength="1" maxlength="3" min="10" max="100" class="form-control" id="peso_kilos" name="peso_kilos" placeholder="" value="0">
                        </div>
                        <label for="field-1" class="col-sm-4 control-label" style="color:gray; text-align: left !important;">kilo(s)</label>
                    </div>
                    <div class="col-sm-6" style="padding: 0px ! important;">
                        <div class="col-sm-6" style="padding: 0px ! important;">
                            <input type="number" required minlength="1" maxlength="3" min="0" max="999"  class="form-control" id="peso_gramos" name="peso_gramos" placeholder="" value="0">
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6" style="padding-top: 7px;">
                    ...
                    <div class="checkbox depenAluDiversidadFuncio" style="display:none">
                      <label><input type="checkbox" name="aluDiversidadOtra" id="aluDiversidadOtra" value="1">Otra</label>
                    </div>

                </div>
            </div>
            <div class="form-group depenOtraDiverfuncional" style="display:none">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6" style="padding-top: 7px;">
                    <label><input type="radio" required class="form-control aluOperado" name="ElAlumnoHaSidoOperado" value="1">Sí</label>
            ...
            <div class="form-group depenAluOperado" style="display:none">
                <label for="field-1" class="col-sm-4 control-label">Especifique qué tipo de intervenciones quirúrgicas ha tenido el alumno</label>
                <div class="col-sm-6">
                    <textarea rows="4" cols="50" name="EspecifiqueTipoOperacion"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="field-1" class="col-sm-4 control-label">El alumno es alérgico<span style="color:red"> *</span></label>
                <div class="col-sm-6" style="padding-top: 7px;">
                    <label><input type="radio" required class="form-control aluAlergico" name="ElAlumnoEsAlergico" value="1">Sí</label>
            ...
            <div class="form-group">
                <label for="field-1" class="col-sm-4 control-label">Sigue algún régimen especial de alimentación o tratamiento<span style="color:red"> *</span></label>
                <div class="col-sm-6" style="padding-top: 7px;">
                    <label><input type="radio" required class="form-control regimenAlimen" name="RegimenEspecialDeAlimentacionOTratamiento" value="1">Sí</label>
            ...
            <div class="form-group depenRegimenAlimen" style="display:none">
                <label for="field-1" class="col-sm-4 control-label">Especifique que tipo de régimen de alimentación o tratamiento tiene el alumno</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="checkbox vacunaNinguna">
                    <label><input type="checkbox" class="requiredVacunaAlu checkVacunaNinguna" name="aluVacunaSarampion" value="1">Sarampión</label>
                    </div>
                    ...
                    <div class="checkbox vacunaNinguna">
                    <label><input type="checkbox" class="requiredVacunaAlu checkVacunaNinguna" id="aluVacunaOtras" name="aluVacunaOtras" value="1">Otras</label>
                    </div>
                </div>
            </div>
            <div class="form-group depende-OtrasVacunas" style="display:none; ">
                <label for="field-1" class="col-sm-4 control-label">Especifique con qué otras vacunas cuenta el alumno</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="checkbox enfermedadNinguna">
                    <label><input type="checkbox" class="requireEnfermedadAlu checkEnfermedadNinguna" id="AluOtraEnfermedad" name="AluOtraEnfermedad" value="1">Otras</label>
                    </div>
                </div>
            </div>
            <div class="form-groupd depende-OtrasEnfermedades" style="display:none; ">
