        ...
        <form id="form-datos-madre" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group depen-madre-vive" style="<?php echo ($row['LaMadreVive'] !== '1')?'display:none':'' ?>">
                ...
                <div class="col-sm-6" style="padding-top: 7px;">
                    ...
                    <label><input type="radio" class="form-control tipoNacMadre" name="NacionalidadMadre" value="EXTRANJERA" <?php echo ($row['NacionalidadMadre']=='NACIONALIZADA')?'checked':'' ?> >Nacionalizada</label>
                </div>
            </div>
            ...
            <div class="form-group only-hide-madre tipoNacDepenMadreEx" style="<?php echo ($row['LaMadreVive'] !== '1')?'display:none':($row['NacionalidadMadre']=='VENEZOLANA')?'display:none':'' ?>" >
            ...
            <div id="sectorMunicipioMadre" class="form-group only-hide-madre depen-madre-vive" style="<?php echo ($row['LaMadreVive'] !== '1')?'display:none':($row['MunicipioDondeResideLaMadre']=='183')?'display:none':'' ?>">
...
<div id="madre-elegida" class="box-content madre-elegida-repre" style="<?php echo ($row['ParentescoConElAlumno']=='MADRE')?'':'display:none' ?>">
    <p>Los campos sobre datos se han deshabilitado porque usted ha indicado previamente que la madre es la representante, por lo que no es necesario repetir la información.
    </p>
