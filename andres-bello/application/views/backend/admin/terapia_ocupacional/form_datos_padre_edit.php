    ...
    <div class="box-content main" style="<?php echo ($row['ParentescoConElAlumno']=='PADRE')?'display:none':'' ?>">
        <form id="form-datos-padre" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <button type="button" id="anterior-datos-padre-to" class="btn btn-info">Anterior</button>
                </div>
                <div class="col-sm-2"></div>
                <div class="col-sm-4">
                    <button type="button" id="siguiente-datos-padre-to" class="btn btn-info">Siguiente</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="box-content padre-elegida-repre" style="<?php echo ($row['ParentescoConElAlumno']=='PADRE')?'':'display:none' ?>">
        ...
        <div class="form-horizontal form-groups-bordered form-censo">
                <div class="form-group">
                    <div class="col-sm-2"></div>
                    <div class="col-sm-4">
                        <button type="button" id="anterior-datos-padre-dos-to" class="btn btn-info">Anterior</button>
                    </div>
                    <div class="col-sm-2"></div>
                    <div class="col-sm-4">
                        <button type="button" id="siguiente-datos-padre-dos-to" class="btn btn-info">Siguiente</button>
                    </div>
                </div>
        </div>
    </div>
