        ...
        <table class="table table-bordered datatable">
            ...
            <tbody>
                ...
                <?php
                    ...
                    $students   =   $this->db->get_where('vestudiantesasistencia' , array('SeccionACursar'=>$section_id, 'id_escuela'=>$id_school, 'GradoACursar'=>$class_id, 'registro_activo'=>1))->result_array();
                        ...
                        <tr class="gradeA">
                            ...
                            <?php
                                ...
                                $verify_data    =   array( 'student_id' => $row['id_inscripcion'], 'date' => $full_date, 'id_escuela' => $id_school);
