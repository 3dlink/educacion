...
$estudiantes = Inscripcion::where('registro_activo', '=' , 1)
                                        ...
                                        ->where('StatusCenso', '=' , 0)
                                        ->orderby('CedulaDeIdentidadDelRepresentante')
                                        ->get();
?>
    ...
    <table class="table table-bordered datatable" id="table_export">
        ...
        ?>
                    <tr>
                        ...
                        <td>
                            <?php $nacionalidad = ($estudiante->NacionalidadDelRepresentante == 'VENEZOLANA' ? 'V' : 'E') ?>
                            <?php echo $nacionalidad.$estudiante->CedulaDeIdentidadDelRepresentante ; ?>
                        </td>
                        <td>
                            <?php echo $estudiante->PrimerApellidoDelRepresentante.' '.$estudiante->SegundoApellidoDelRepresentante.' '.$estudiante->PrimerNombreDelRepresentante.' '.$estudiante->SegundoNombreDelRepresentante; ?>
                        </td>
                        <td>
