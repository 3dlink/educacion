        ...
        <form id="form-datos-alumno" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                        ...
                        <input type="hidden" required minlength="2" class="form-control" id="aluNombreFoto" name="aluNombreFoto" value="" >
                        <input type="hidden" required minlength="2" class="form-control" id="id_censo" name="id_censo" value="<?php echo $id_inscripcion ?>" >
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group" id="cedulaIdentidadAlumno" style=" <?php ($grado_cursar >= 8) ? 'display: none;' : ''?> ">
                <div class="col-sm-12">
            ...
            <div class="form-group">
              <label for="field-1" class="col-sm-4 control-label">Cédula de identidad</label><?php ($grado_cursar >= 8) ? '<span style="color:red"> *</span>' : '' ?>
              <div class="col-sm-6">
                  <input type="text" minlength="8" class="form-control" id="aluCedula" name="CedulaDeIdentidadDelAlumnoOCedulaEscolar" placeholder="Cédula de identidad del alumno" value="<?php echo $row['CedulaDeIdentidadDelAlumnoOCedulaEscolar']?>" <?php ($grado_cursar >= 8) ? 'required' : '' ?> >
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6" style="padding-top: 7px;">
                      ...
                      <label><input type="radio" id="aluNacNac" class="form-control" name="NacionalidadDelAlumno" value="NACIONALIZADO" <?php echo ($row['NacionalidadDelAlumno']=='NACIONALIZADO')?'checked':'' ?> >Nacionalizado</label>
              </div>
            </div>
