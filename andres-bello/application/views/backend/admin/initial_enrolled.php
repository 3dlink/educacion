...
?>
    ...
    <div class="showTableResumen" style="<?php echo ($mostrar_tabla=='no_mostrar')?'display:none':'' ?>">
        <table class="table table-bordered datatable showTableResumen" id="table_export" >
            <thead>
                <tr>
                    <th width="50" rowspan="2"><?php echo "Nº"?></th>
                    <th width="180" rowspan="2"><div>Cédula de Identidad</div></th>
                    <th width="200" rowspan="2"><div>Apellidos</div></th>
                    <th width="200" rowspan="2"><div>Nombres</div></th>
                    <th width="80" rowspan="2"><div>Sexo</div></th>
                    <th width="80" rowspan="2"><div>Grado y Sección</div></th>
                    <th width="80" colspan="3"><div style="text-align: center;">Fecha de Nac</div></th>
                    <th width="80" colspan="5"><div style="text-align: center;">Escolaridad</div></th>
                </tr>
                <tr>
                    <th width="60" style="text-align: center;">Día</th>
                    <th width="60" style="text-align: center;">Mes</th>
                    <th width="60" style="text-align: center;">Año</th>
                    <th width="60" style="text-align: center;">RG</th>
                    <th width="60" style="text-align: center;">RP</th>
                    <th width="60" style="text-align: center;">MP</th>
                    <th width="60" style="text-align: center;">DI</th>
                    <th width="60" style="text-align: center;">NI</th>
                </tr>
            </thead>
            <tbody>
                <?php
                    ...
                    foreach($estudiantes as $row):
                      ...
                      <tr>
                          ...
                          <td><?php echo $this->crud_model->get_type_section_by_id('secciones',$row['SeccionACursar']);?></td>
                          <?php
                          ...
                          ?>
                          <td style="text-align: center;"><?php echo $dia_nacimiento;?></td>
                          <td style="text-align: center;"><?php echo $mes_nacimiento;?></td>
                          <td style="text-align: center;"><?php echo $ano_nacimiento;?></td>

                          <td style="text-align: center;"><?php echo "X";?></td>
                          <td style="text-align: center;"><?php echo "*";?></td>
                          <td style="text-align: center;"><?php echo "*";?></td>
                          <td style="text-align: center;"><?php echo "*";?></td>
                          <td style="text-align: center;"><?php echo $this->crud_model->get_type_new_inscription($row['id_inscripcion']);?></td>
                      </tr>
                <?php endforeach;?>
            </tbody>
        </table>
