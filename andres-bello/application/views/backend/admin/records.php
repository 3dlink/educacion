        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url().$this->session->userdata('login_type').'/search_carnet' , array('class' => 'form-horizontal form-groups-bordered carnet','role' => 'form' ,'target'=>'_top', 'id'=>'form-constancias'));?>
                                ...
                                <div class="box closable-chat-box">
                                    <div class="box-content padded">
                                        <div class="chat-message-box">
                                           <input type="text" name="txtIdentification" id="txtIdentification" rows="5" placeholder="Ej. 25333555" class="form-control" value="<?php echo $CedulaAlumno ?>" required autofocus>
                        ...
                        <div class="form-group oculto" id="linkConstanciaAsistencia">
                            ...
                            <div class="col-sm-4">
                                <input type="date" name="txtFecha" id="txtFecha" rows="5" placeholder="Fecha" class="form-control" required readonly value="<?php echo date("d-m-Y");?>">
...
<script>
  jQuery(document).ready(function ($) {
        ...
        $('#txtFechaConvocatoria').mask("00-00-0000", {placeholder: "DD-MM-AAAA"});
        $('#txtHora').mask('00:00', {placeholder: "__:__: __"});
        $('#txtDesde').mask("00:00", {placeholder: "__:__: __"});
        $('#txtHasta').mask("00:00", {placeholder: "__:__: __"});
  });
</script>