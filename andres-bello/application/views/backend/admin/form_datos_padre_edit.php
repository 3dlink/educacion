...
<div class="tab-pane box" id="datosPadre">
    <div class="box-content main" style="<?php echo ($row['ParentescoConElAlumno']=='PADRE')?'display:none':'' ?>">
        <form id="form-datos-padre" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group depen-padre-vive" style="<?php echo ($row['ElPadreVive'] !== '1')?'display:none':'' ?>">
            ...
            <div class="form-group depen-padre-vive" style="<?php echo ($row['ElPadreVive'] !== '1')?'display:none':'' ?>">
                ...
                <div class="col-sm-6" style="padding-top: 7px;">
                    ...
                    <label><input type="radio" class="form-control tipoNacPadre" name="NacionalidadDelPadre" value="EXTRANJERA" <?php echo ($row['NacionalidadDelPadre']=='NACIONALIZADA')?'checked':'' ?> >Nacionalizada</label>
                </div>
            </div>
            ...
            <div class="form-group only-hide-padre depen-padre-vive" style="<?php echo ($row['ElPadreVive'] !== '1')?'display:none':'' ?>">
            ...
            <div id="sectorMunicipioChacaoPadre" class="form-group only-hide-padre depen-padre-vive" style="<?php echo ($row['ElPadreVive'] !== '1')?'display:none':($row['MunicipioDondeResideElPadre']=='183')?'display:none':'' ?>">
            ...
            <div  id="sectorMunicipioPadre" class="form-group only-hide-padre depen-padre-vive" style="<?php echo ($row['ElPadreVive'] !== '1')?'display:none':($row['MunicipioDondeResideElPadre']=='183')?'display:none':'' ?>" >
    ...
    <div class="box-content padre-elegida-repre" style="<?php echo ($row['ParentescoConElAlumno']=='PADRE')?'':'display:none' ?>">
        <p>Los campos sobre datos se han deshabilitado porque usted ha indicado previamente que el padre es el representante, por lo que no es necesario repetir la información.</p>
