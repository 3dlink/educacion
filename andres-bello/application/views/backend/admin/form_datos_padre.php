    ...
    <div class="box-content main">
        <form id="form-datos-padre" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group">
                <label for="field-1" class="col-sm-4 control-label">Padre <span style="color:red"> *</span></label>
                <div class="col-sm-6" style="padding-top: 7px;">
                    <label><input type="radio" required class="form-control padre-viva" name="ElPadreVive" value="1">Vivo</label>
                    <label><input type="radio" class="form-control padre-viva" name="ElPadreVive" value="0">Fallecido</label>
                    <label><input type="radio" class="form-control padre-viva" name="ElPadreVive" value="2">Ausente</label>
                </div>
            </div>
            ...
            <div class="form-group depen-padre-vive" style="display:none">
                ...
                <div class="col-sm-6" style="padding-top: 7px;">
                    ...
                    <label><input type="radio" class="form-control tipoNacPadre" name="NacionalidadDelPadre" value="EXTRANJERA" >Nacionalizada</label>
                </div>
            </div>
