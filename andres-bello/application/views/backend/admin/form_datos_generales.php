    ...
    <div class="box-content">
        <form id="form-general" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group" id="div-materia-repite" style="display:none">
                ...
                <div class="col-sm-6">
                        <select id="MateriasRepite" name="MateriasRepite" class="form-control" style="width:100%;" id="subject_selection_repeat_holder" multiple>
            ...
            <div class="form-group div-materia-pendiente" style="display:none">
                ...
                <div class="col-sm-6">
                        <select id="MateriasPendientes" name="MateriasPendientes" class="form-control" style="width:100%;" id="subject_selection_holder" multiple>
                            <option value=""><?php echo "Seleccione primero el grado"?></option>
                        </select>
                </div>
            </div>
