        ...
        <form id="form-datos-madre" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6" style="padding-top: 7px;">
                    <label><input type="radio"  class="form-control madre-viva" name="LaMadreVive" value="1">Viva</label>
                    <label><input type="radio" class="form-control madre-viva" name="LaMadreVive" value="0">Fallecida</label>
                    <label><input type="radio" class="form-control madre-viva" name="LaMadreVive" value="2">Ausente</label>
                </div>
            </div>
            ...
            <div class="form-group depen-madre-vive" style="display:none">
                ...
                <div class="col-sm-6" style="padding-top: 7px;">
                    ...
                    <label><input type="radio" class="form-control tipoNacMadre" name="NacionalidadMadre" value="NACIONALIZADO">Nacionalizado</label>
                </div>
            </div>
