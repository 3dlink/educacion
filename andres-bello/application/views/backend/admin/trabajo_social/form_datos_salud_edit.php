        ...
        <form id="form-datos-saludalu" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="col-sm-6" style="padding: 0px ! important;">
                        <div class="col-sm-6" style="padding: 0px ! important;">
                            <input type="number" required minlength="1" maxlength="1" min="0" max="2" class="form-control" id="estatura_metros" name="estatura_metros" placeholder="" value="<?php echo $row['estatura_metros']; ?>">
                        </div>
                        <label for="field-1" class="col-sm-4 control-label" style="color:gray; text-align: left !important;">metro(s)</label>
                    </div>
                    <div class="col-sm-6" style="padding: 0px ! important;">
                        <div class="col-sm-6" style="padding: 0px ! important;">
                            <input type="number" required minlength="1" maxlength="2" min="0" max="99" class="form-control" id="estatura_centimetros" name="estatura_centimetros" placeholder="" value="<?php echo $row['estatura_centimetros']; ?>">
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="col-sm-6" style="padding: 0px ! important;">
                        <div class="col-sm-6" style="padding: 0px ! important;">
                            <input type="number" required minlength="1" maxlength="3" min="10" max="100" class="form-control" id="peso_kilos" name="peso_kilos" placeholder="" value="<?php echo $row['peso_kilos']; ?>">
                        </div>
                        <label for="field-1" class="col-sm-4 control-label" style="color:gray; text-align: left !important;">kilo(s)</label>
                    </div>
                    <div class="col-sm-6" style="padding: 0px ! important;">
                        <div class="col-sm-6" style="padding: 0px ! important;">
                            <input type="number" required minlength="1" maxlength="3" min="0" max="999" class="form-control" id="peso_gramos" name="peso_gramos" placeholder="" value="<?php echo $row['peso_gramos']; ?>">
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <button type="button" id="anterior-datos-salud-ts" class="btn btn-info">Anterior</button>
                </div>
                <div class="col-sm-2"></div>
                <div class="col-sm-4">
                    <button type="button" id="siguiente-datos-salud-ts" class="btn btn-info">Siguiente</button>
                </div>
            </div>
        </form>
    </div>
