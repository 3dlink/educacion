    ...
    <div class="box-content">
        <form id="form-general" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label><input type="radio" required class="form-control" name="Residente" value="1">Sí</label>
                    <label><input type="radio" class="form-control" name="Residente" value="0">No</label>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="secondname" class="col-sm-4 control-label">El alumno estudia actualmente<span style="color:red"> *</span></label>
                <div class="col-sm-6">
                    <label><input type="radio" required class="form-control" name="ElAlumnoEstudiaActualmente" value="1">Sí</label>
                    <label><input type="radio" class="form-control" name="ElAlumnoEstudiaActualmente" value="0">No</label>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group dependiente-UniProc">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                     <div class="checkbox">
                      <label><input type="checkbox" name="UniDePrefJuanDio" class="requireUniEdu" value="0" disabled>UEM Juan de Dios Guanche</label>
                    </div>

                    <div class="checkbox">
                      <label><input type="checkbox" name="UniDePrefAndres" class="requireUniEdu" value="1" >UEM Andrés Bello</label>
                    </div>

                    <div class="checkbox">
                      <label><input type="checkbox" name="UniDePrefCarlos" class="requireUniEdu" value="0" disabled>UEMI Carlos Soublette</label>
                    </div>
                </div>
            </div>
            <div class="form-group">
