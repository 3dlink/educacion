    ...
    $estudiantes = Puntaje_censo::where('StatusCenso', '=', 2)
                            ->where('UniDePrefAndres', '=', 1)
                            ->get();
    ?>
    <br><br>
    <table class="table table-bordered datatable" id="table_export">
        <thead>
            <tr>
                ...
                <th width="100"><div>Aprobar</div></th>
                <th width="100"><div>Rechazar</div></th>
            </tr>
        </thead>
        <tbody>
            <?php
                foreach($estudiantes as $row):?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php $base_url = base_url().'modal/popup/modal_census_student_aprobe/'; ?>
                        ...
                        <td>
                            <?php $base_url = base_url().'modal/popup/modal_census_student_reprobe/'; ?>
                            <?php $cedula_identidad = $row['cedula_identidad']; ?>
                            <a href="javascript:;" onclick="showAjaxModal('<?php echo $base_url.$id_censo;?>');" class="btn btn-danger">
                                <i class="entypo-pencil"></i>
                                <?php echo "Rechazar"?>
                            </a>
                        </td>
