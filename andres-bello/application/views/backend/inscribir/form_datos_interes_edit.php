        ...
        <form id="form-datos-otros" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="hidden" required minlength="2" class="form-control" id="" name="id_inscripcion" placeholder="" value="<?php echo $row['id_inscripcion']?>" >
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2"></div>
                <div class="col-sm-4">
                    <button type="button" id="siguiente-datos-interes" class="btn btn-info">Editar Inscripción</button>
                </div>
            </div>
        </form>
    </div>
