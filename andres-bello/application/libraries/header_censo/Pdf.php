<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class Pdf extends FPDF {
      ...
      public function Header(){
          ...
          $id_school = $this->CI->config->item('id_school');

          $query = $this->CI->db->where('id_escuela = ', $id_school);
          $query = $this->CI->db->get('escuelas');
          $escuela = $query->result();

          $codigo_dea = "Código DEA: ".$escuela[0]->dea;
          ...
          $this->Cell(0,3,iconv('UTF-8','windows-1252','"'.$escuela[0]->simple_name.'"'),0,50,'C');
          $this->Cell(0,3,iconv('UTF-8','windows-1252', $codigo_dea),0,50,'C');
          $this->Cell(0);
          $this->Cell(40, 40, $this->Image($logo_chacao, 10, 10, 33), 0, 0, 'L', false );
          $this->Cell(40, 40, $this->Image($logo_escuela, 170, 10, 25), 0, 0, 'R', false );
          $this->Ln(10);
          $this->SetFont('Arial','B',8);
      ...
      function Footer()
      {
          ...
          $this->Cell(0,4,iconv('UTF-8','windows-1252',$escuela[0]->direccion),50,50,'L');
          $this->SetFont('Arial', 'B', 8);
          $this->Cell(0,4,iconv('UTF-8','windows-1252',$escuela[0]->telefono),0,50,'L');
          $this->Cell(0,4,iconv('UTF-8','windows-1252',$escuela[0]->correo_electronico),0,50,'L');
