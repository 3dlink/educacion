...
// output
//page_data['breadcums'] = $this->breadcrumbs->show();
    ...
    function anamnesis_ts($param1 = '', $param2 = '' , $param3 = '')
    {
            ...
            $page_data['id_censo_selected'] = $param1;

            $page_data['page_name']  = 'anamnesis_ts';
            $page_data['page_title'] = "ESPECIALIDAD: TRABAJO SOCIAL";
    ...
    function anamnesis_ps($param1 = '', $param2 = '' , $param3 = '')
    {
            ...
            $page_data['page_title'] = "ESPECIALIDAD: PSICOLOGÍA";
    ...
    function anamnesis_psc($param1 = '', $param2 = '' , $param3 = '')
    {
            ...
            $page_data['page_title'] = "ESPECIALIDAD: PSICOPEDAGOGÍA";
    ...
    function anamnesis_to($param1 = '', $param2 = '' , $param3 = '')
    {
            if ($this->session->userdata('admin_login') != 1)
                redirect(base_url(), 'refresh');
            ...
            $page_data['page_name']  = 'anamnesis_to';
            $page_data['page_title'] = "ESPECIALIDAD: TERAPIA OCUPACIONAL";
    ...
    /***ANAMNESIS LENGUAJE ***/
    function anamnesis_tl($param1 = '', $param2 = '' , $param3 = '')
    {
            if ($this->session->userdata('admin_login') != 1)
                redirect(base_url(), 'refresh');
            ...
            $page_data['page_name']  = 'anamnesis_tl';
            $page_data['page_title'] = "ESPECIALIDAD: TERAPIA DEL LENGUAJE";
    ...
    function records($param1='')
    {
            ...
            $config = Configuracion::all();
            $page_data['config'] = $config;
            $page_data['CedulaAlumno'] = $param1;

            $this->load->view('backend/index', $page_data);
    }

    /***CARNETS***/
    function carnets($param1='')
    {
            if ($this->session->userdata('admin_login') != 1)
                redirect(base_url(), 'refresh');

                $page_data['page_name']  = 'carnets';
                $page_data['page_title'] = "CARNETIZACIÓN";
    ...
    function bulletin($param1 = '')
    {
            ...
            if ($param1 == 'enviar'){
                    $this->mostrar_bulletin($seccion, $grado, $lapso);
            }
            ...
            $config = Configuracion::all();
            $page_data['config'] = $config;
            $page_data['page_name']  = 'bulletin';
            $page_data['page_title'] = "GENERACIÓN DE BOLETA DE CALIFICACIONES";
...
//                }
    ...
    function student_new($param1 = '', $param2 = '' , $param3 = '')
    {
            if ($this->session->userdata('admin_login') != 1)
                ...
                $page_data['cupos_escuelas']   = $this->db->where('id_escuela', $this->config->item('id_school'))->get('escuelas')->result_array();
                $page_data['inscritos_escuelas'] = $this->db->get_where('vmatriculasexo', array('id_escuela' => $id_school))->result_array();
    ...
    function student_edit($param1 = '', $param2 = '' , $param3 = '')
    {
            ...
            if($param2 == 'retire'){
                ...
                $this->session->set_flashdata('flash_message' , 'Alumno retirado satisfactoriamente');
    ...
    function student_certificate($param1 = '')
    {
            ...
            $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Parroquia:     '.$parroquia_alumno),0,50,'L');
    ...
    function student_carnet($param1 = '')
    {
            ...
            $meses = array("Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
            $director_uem = $escuela->director->name;
            $cedula_director = $escuela->director->cedula_identidad;
            $Seccion = $secciones->letra_seccion;
            $dias_constancia = date('d');
            $mes_constancia = $meses[date('n')-1];
    ...
    function student_constancy($tipo_constancia = '', $id_estudiante = '', $param1 = '', $param2 = '')
    {
            ...
            $escuela = Escuela::find($this->config->item('id_school'));
            $secciones = Seccion::find($censo->SeccionACursar);
            $usuario = Usuario::where('id_usuario', '=', $this->session->userdata('login_user_id'))
                                            ->get();
    ...
    function parent_enrolled()
    {
            ...
            $config = Configuracion::all();
            $page_data['config'] = $config;
            $page_data['page_name']  = 'parent_enrolled';
            $page_data['page_title'] = "LISTADO DE REPRESENTANTES";
    ...
    function student_enrolled_upe()
    {
            ...
            $config = Configuracion::all();
            $page_data['config'] = $config;
            $page_data['page_name']  = 'student_enrolled_upe';
            $page_data['page_title'] = "ESTUDIANTES INSCRITOS";

            $this->load->view('backend/index', $page_data);
    }

    function student_referred($param1 = '')
    {
            if ($this->session->userdata('admin_login') != 1)
                redirect('login', 'refresh');

            if ($param1 == 'create') {
                $data['id_inscripcion'] = $this->input->post('id_inscripcion');
                $data['fecha'] = $this->input->post('fecha_referido');
                $data['referido_a'] = $this->input->post('referido_a');
                $data['motivo_referencia'] = $this->input->post('motivo_referencia');
                $data['referido_por'] = $this->input->post('referido_por');

                $this->db->insert('referidos', $data);
                $id_persona = $this->db->insert_id();

                $this->session->set_flashdata('flash_message' , 'Registro agregado satisfactoriamente');

                redirect(base_url() . 'admin/student_referred/', 'refresh');
            }

            $config = Configuracion::all();
            $page_data['config'] = $config;
            $page_data['page_name']  = 'student_referred';
            $page_data['page_title'] = "ESTUDIANTES REFERIDOS A LA UDAEM";

            $this->load->view('backend/index', $page_data);
    }

    function under_construccion()
    {
            if ($this->session->userdata('admin_login') != 1)
                redirect('login', 'refresh');
            ...
            $config = Configuracion::all();
            $page_data['config'] = $config;
            $page_data['page_name']  = 'under_construccion';
            $page_data['page_title'] = "FUNCIONALIDAD EN DESARROLLO";
    ...
    function subject($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $data['abreviacion']       = $this->input->post('abreviacion');
            $data['abreviacion_boletin']   = $this->input->post('abreviacion_boletin');
            $data['educacion_trabajo'] = $this->input->post('educacion_trabajo');
            $data['color'] = $this->input->post('color');

            $this->db->insert('asignatura', $data);
            $this->session->set_flashdata('flash_message' , 'Registro agregado satisfactoriamente');
            redirect(base_url().$this->session->userdata('login_type').'/subject/'.$param1, 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']       = $this->input->post('name');
            $data['id_grado']   = $this->input->post('id_grado');
            ...
            $this->db->where('asignatura_id', $param2);
        ...
        $page_data['id_escuela']   = $id_school;
        $page_data['subjects']   = $this->db->get_where('asignatura' , array('id_grado' => $param1, 'registro_activo' => 1 ))->result_array();
    ...
    function get_class_section($class_id)
    {
        ...
        $sections = $this->db->get_where('vescuelaseccion' , array('id_grado' => $class_id, 'id_escuela' => $id_school))->result_array();
        foreach ($sections as $row) {
            echo '<option value="' . $row['id_seccion'] . '">' . $row['nombre_seccion'] . '</option>';
        }
    }

    function get_quota_by_school_grade($class_id)
    {
        $id_school = $this->config->item('id_school');

        $inscritos = $this->db->get_where('vcupos_grado_escuela', array('id_escuela' => $id_school, 'id_grado' => $class_id))->row('Total');
        $cupos = $this->db->get_where('vcupos_grado_escuela', array('id_escuela' => $id_school, 'id_grado' => $class_id))->row('cupos');
        $cupos_maximo = $this->db->get_where('vcupos_grado_escuela', array('id_escuela' => $id_school, 'id_grado' => $class_id))->row('cupos_maximo');
        $disponibles = 0;

        if ($cupos == $cupos_maximo) {
            $disponibles = $cupos - $inscritos;
        }else{
            $disponibles = $cupos_maximo - $inscritos;
        }
    ...
    function exam($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param2 == 'create') {
            ...
            if($ponderacion_total_resultado < 100){
                ...
                $data['fecha_objetivo_desde'] = $this->input->post('fecha_objetivo_desde');
                $data['fecha_objetivo_hasta'] = $this->input->post('fecha_objetivo_hasta');
                $data['subject_id']    = $this->input->post('subject_id');
                $data['examen_lapso']    = $this->input->post('examen_lapso');
                $data['class_lapso']    = $this->input->post('class_lapso');

                $this->db->insert('exam', $data);
                $id_exam = $this->db->insert_id();

                //tecnicas
                foreach ($_POST['id_tecnica'] as $tecnica) {
                    $data_tecnica['id_tecnica'] = $tecnica;
                    $data_tecnica['id_exam'] = $id_exam;
                    $this->db->insert('tecnicas_exam', $data_tecnica);

                }
                //actividades
                foreach ($this->input->post('id_actividad') as $actividad) {
                    $data_actividad['id_actividad'] = $actividad;
                    $data_actividad['id_exam'] = $id_exam;
                    $this->db->insert('actividades_exam', $data_actividad);
                }
                //recursos
                foreach ($this->input->post('id_recurso') as $recurso) {
                    $data_recurso['id_recurso'] = $recurso;
                    $data_recurso['id_exam'] = $id_exam;
                    $this->db->insert('recursos_exam', $data_recurso);
                }
        ...
        if ($param2 == 'edit') {
            ...
            //tecnicas
            foreach ($this->input->post('id_tecnica') as $tecnica) {
                $data_tecnica['id_tecnica'] = $tecnica;
                $this->db->where('id_exam', $param3);
                $this->db->update('exam', $data_tecnica);
            ...
            foreach ($this->input->post('id_actividad') as $actividad) {
                $data_actividad['id_actividad'] = $actividad;
                $this->db->where('id_exam', $param3);
                $this->db->update('exam', $data_actividad);
            }
            //recursos
            foreach ($this->input->post('id_recurso') as $recurso) {
                $data_recurso['id_recurso'] = $recurso;
                $this->db->where('id_exam', $param3);
                $this->db->update('exam', $data_recurso);
            }
            $this->session->set_flashdata('flash_message' , 'Registro actualizado');
            redirect(base_url().$this->session->userdata('login_type').'/exam/'.$nivel_educativo[0]->id_nivel_educativo, 'refresh');
        }
    ...
    function project($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param2 == 'create') {
            ...
            $data['class_lapso']    = $this->input->post('class_lapso');
            $data['teacher_id'] = $this->input->post('teacher_id');
            $data['name_tema']    = $this->input->post('name_tema');
            $data['name_selAlc']    = $this->input->post('name_selAlc');
            $data['name_cotAlc'] = $this->input->post('name_cotAlc');
            $data['name_medAlc']    = $this->input->post('name_medAlc');
            $data['name_larAlc'] = $this->input->post('name_larAlc');
            $data['name_texareaDiag'] = $this->input->post('name_texareaDiag');
            $data['name_texareaPropo']    = $this->input->post('name_texareaPropo');
            $data['name_texareaActi']    = $this->input->post('name_texareaActi');
            $data['id_nivel_educativo']    = $nivel_educativo[0]->id_nivel_educativo;
            $data['id_escuela']    = $id_school;

            $this->db->insert('projectos', $data);
            $id_project = $this->db->insert_id();

            //tecnicas
            foreach ($this->input->post('id_actividad') as $tecnica) {
                $data_tecnica['id_tecnica'] = $tecnica;
                $data_tecnica['id_exam'] = $id_project;
                $this->db->insert('tecnicas_projecto', $data_tecnica);

            }
            //actividades
            foreach ($this->input->post('id_actividad') as $actividad) {
                $data_actividad['id_actividad'] = $actividad;
                $data_actividad['id_exam'] = $id_project;
                $this->db->insert('actividades_projecto', $data_actividad);
            }
            //recursos
            foreach ($this->input->post('id_recurso') as $recurso) {
                $data_recurso['id_recurso'] = $recurso;
                $data_recurso['id_exam'] = $id_project;
                $this->db->insert('recursos_projecto', $data_recurso);
            }
        ...
        if ($param2 == 'edit') {
            ...
            $this->db->where('id_projecto', $param3);
            $this->db->update('projectos', $data);

            //tecnicas
            foreach ($this->input->post('id_actividad') as $tecnica) {
                $data_tecnica['id_tecnica'] = $tecnica;
                $this->db->where('id_exam', $param3);
                $this->db->update('tecnicas_projecto', $data_tecnica);
            }
            //actividades
            foreach ($this->input->post('id_actividad') as $actividad) {
                $data_actividad['id_actividad'] = $actividad;
        ...
        $page_data['projects'] = $this->db->get_where('projectos' , array('id_nivel_educativo' => $param1, 'id_escuela' => $id_school, 'registro_activo' => 1))
                                    ->result_array();
        $page_data['id_nivel_educativo']  = $nivel_educativo[0]->id_nivel_educativo;
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , 'Registro eliminado');
            redirect(base_url().$this->session->userdata('login_type').'/class_routine/'.$param3, 'refresh');
        }
    ...
    function menu($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $data['desayuno']        = $this->input->post('desayuno');
            $data['almuerzo'] = $this->input->post('almuerzo');
            $data['contorno'] = $this->input->post('contorno');
            $data['merienda'] = $this->input->post('merienda');
            $data['bebida']        = $this->input->post('bebida');

            $this->db->insert('menu_semanal', $data);
            $this->session->set_flashdata('flash_message' , 'Registro agregado satisfactoriamente');
            redirect(base_url().$this->session->userdata('login_type').'/menu.tkml', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['desde']   = $this->input->post('desde');
            $data['hasta'] = $this->input->post('hasta');
            ...
            $this->db->where('id_menu_semanal', $param2);
            $this->db->update('menu_semanal', $data);
            $this->session->set_flashdata('flash_message' , 'Registro actualizado satisfactoriamente');
            redirect(base_url().$this->session->userdata('login_type').'/menu.tkml', 'refresh');
        } else if ($param1 == 'edit') {
            $page_data['edit_data'] = $this->db->get_where('menu_semanal', array(
                'id_menu_semanal' => $param2
            ))->result_array();
        }
        if ($param1 == 'delete') {
            $data['activo'] = 0;
        ...
        $page_data['edit_data'] = $this->db->get_where('menu_semanal', array('id_menu_semanal' => $param2))->result_array();

        $page_data['almuerzos']  = $this->db->get_where('almuerzo' , array('active' => 1))->result_array();
        $page_data['desayunos']  = $this->db->get_where('desayuno' , array('active' => 1))->result_array();
        $page_data['meriendas']  = $this->db->get_where('merienda' , array('active' => 1))->result_array();
        $page_data['contornos']  = $this->db->get_where('contorno' , array('active' => 1))->result_array();
        $page_data['bebidas']  = $this->db->get_where('bebida' , array('active' => 1))->result_array();

        $day = date('w');
        $week_start = date('d/m/Y', strtotime('-'.$day.' days'));
        $week_end = date('d/m/Y', strtotime('+'.(6-$day).' days'));

        $page_data['fecha_desde'] = date('m/d/Y', strtotime('-'.$day.' days'));
        $page_data['fecha_hasta'] = date('m/d/Y', strtotime('+'.(6-$day).' days'));


        $page_data['page_title'] = "MENÚ DE LA SEMANA DEL ".$week_start.'  AL '.$week_end;
    ...
    function manage_attendance($date='',$month='',$year='',$nivel_educativo='',$class_id='', $section_id='', $subject_id='')
    {
        ...
        if($_POST)
        {
            ...
            foreach ($students as $row)
            {
                ...
                $this->db->update('attendance' , array('status' => $attendance_status, 'is_late' => $attendance_late, 'id_escuela' => $id_school));
            }
    ...
    function mostrar_matricula_inicial($param1='', $param2='')
    {
            ...
            switch ($array_nivel_educativo[0]->id_nivel_educativo) {
                case '1':
                    $subdirector_nivel = $escuela->subdirector_inicial->primer_apellido.' '.$escuela->subdirector_inicial->segundo_apellido.' '.$escuela->subdirector_inicial->primer_nombre.' '.$escuela->subdirector_inicial->segundo_nombre;
                    $subdirector_cedula = $escuela->subdirector_inicial->cedula_identidad;
                    break;
                case '2':
                    $subdirector_nivel = $escuela->subdirector_basica->primer_apellido.' '.$escuela->subdirector_basica->segundo_apellido.' '.$escuela->subdirector_basica->primer_nombre.' '.$escuela->subdirector_basica->segundo_nombre;
                    $subdirector_cedula = $escuela->subdirector_basica->cedula_identidad;
                    break;
                case '3':
                    $subdirector_nivel = $escuela->subdirector_media->primer_apellido.' '.$escuela->subdirector_media->segundo_apellido.' '.$escuela->subdirector_media->primer_nombre.' '.$escuela->subdirector_media->segundo_nombre;
                    $subdirector_cedula = $escuela->subdirector_media->cedula_identidad;
                    break;
            }
            ...
            $this->pdf->SetX(185);
            $this->pdf->Cell(0,72,iconv('UTF-8','windows-1252','RG  RP  MP  NI'),0,50,'J');

            $yLocation = 98;
            $observaciones = '';
            for ( $i = 1 ; $i <= $total_alumnos_seccion ; $i ++) {
                        ...
                        if($i <= count($censo)){
                            ...
                            if($censo[$i - 1]->NacionalidadDelAlumno == "EXTRANJERA"){
                            ...
                            $ni = $this->crud_model->get_type_new_inscription($censo[$i - 1]->id_inscripcion);
                            ...
                            $this->pdf->SetY($yLocation);
                            $this->pdf->SetX(202);
                            $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252',$ni),0,50,'J');
                        }

                        $yLocation = $yLocation + 5;
                        if ($i <  $total_alumnos_seccion){
            ...
            $this->pdf->SetX(111);
            $this->pdf->SetFont('Arial', '', 8);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Subdirector (a)'),0,50,'J');

            $this->pdf->SetY(313);
            $this->pdf->SetX(111);
            $this->pdf->SetFont('Arial', '', 8);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$subdirector_nivel),0,50,'J');
            ...
            $this->pdf->SetX(111);
            $this->pdf->SetFont('Arial', '', 8);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$subdirector_cedula),0,50,'J');
    ...
    function roster($param1='', $param2='')
    {
            ...
            $full_name = $escuela->full_name;
            $uem_name = $escuela->nombre_escuela;
            $uem_direccion = $escuela->direccion;
            $uem_direccion = $escuela->telefono;
            $director_uem = $escuela->director->primer_apellido.' '.$escuela->director->segundo_apellido.' '.$escuela->director->primer_nombre.' '.$escuela->director->segundo_nombre;
            $director_cedula = $escuela->director->cedula_identidad;
            ...
            $this->pdf->SetTitle(iconv('UTF-8','windows-1252','Nomina'));
            $this->pdf->SetLeftMargin(15);
            $this->pdf->SetRightMargin(15);

            $this->pdf->SetFont('Arial','U',12);
            $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Nómina Escolar'),0,50,'C');
            ...
            $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Cód. Plantel: '.$cod_dea. '             Nombre: '.$full_name. '      Dtto.esc: 07'),0,50,'J');
            $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Dirección: '.$uem_direccion.'                Telefono: '.$uem_telefono),0,50,'J');
            $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Municipio: CHACAO                Ent. Federal: MIRANDA                Zona Educativa: MIRANDA'),0,50,'J');
            ...
            $this->pdf->Cell(0,28,iconv('UTF-8','windows-1252','Nombres'),0,50,'J');
            $this->pdf->SetX(155);
            $this->pdf->Cell(0,-32,iconv('UTF-8','windows-1252',''),0,50,'J');
            $this->pdf->Cell(0,38,iconv('UTF-8','windows-1252',''),0,50,'J');
            $this->pdf->SetX(162);
            $this->pdf->Cell(0,-44,iconv('UTF-8','windows-1252',''),0,50,'J');
            $this->pdf->SetX(161);
            $this->pdf->Cell(0,53,iconv('UTF-8','windows-1252',''),0,50,'J');
            $this->pdf->SetX(187);
            $this->pdf->Cell(0,-62,iconv('UTF-8','windows-1252',''),0,50,'J');
            $this->pdf->SetX(185);
            $this->pdf->Cell(0,72,iconv('UTF-8','windows-1252',''),0,50,'J');

            $yLocation = 98;
            $observaciones = '';
            for ( $i = 1 ; $i <= $total_alumnos_pagina ; $i ++) {
                        $this->pdf->SetY($yLocation);
                        $this->pdf->SetX(10);
                        $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252',$i),0,50,'J');
            ...
            $this->pdf->SetX(175);
            $this->pdf->SetFont('Arial', '', 8);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Docente'),0,50,'J');

            $this->pdf->SetY(313);
            $this->pdf->SetX(175);
            $this->pdf->SetFont('Arial', '', 8);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$this->crud_model->get_teacher_name($array_nivel_educativo[0]->teacher_id)),0,50,'J');
            ...
            $this->pdf->SetX(175);
            $this->pdf->SetFont('Arial', '', 8);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$this->crud_model->get_teacher_cedula($array_nivel_educativo[0]->teacher_id)),0,50,'J');
            ...
            $this->pdf->Line(155, 87, 155, ($yLocation - 1)); //Linea Vertical
            $this->pdf->Line(160, 87, 160, ($yLocation - 1)); //Linea Vertical
            $this->pdf->Line(165, 87, 165, ($yLocation - 1)); //Linea Vertical
            $this->pdf->Line(170, 87, 170, ($yLocation - 1)); //Linea Vertical
            $this->pdf->Line(175, 87, 175, ($yLocation - 1)); //Linea Vertical
            $this->pdf->Line(180, 87, 180, ($yLocation - 1)); //Linea Vertical
            $this->pdf->Line(185, 87, 185, ($yLocation - 1)); //Linea Vertical
            $this->pdf->Line(190, 87, 190, ($yLocation - 1)); //Linea Vertical
            $this->pdf->Line(195, 87, 195, ($yLocation - 1)); //Linea Vertical
            $this->pdf->Line(200, 87, 200, ($yLocation - 1)); //Linea Vertical
            $this->pdf->Line(10, 97, 207, 97); //Linea Horizontal

            $this->pdf->Output();
    }

    function mostrar_bulletin($param1='', $param2='', $param3='')
    {
            $this->load->model('Configuracion');
            $this->load->model('Seccion');
            $this->load->model('Grado');
            ...
            $grado = $array_nivel_educativo[0]->numero_grado;
            $seccion = $array_nivel_educativo[0]->letra_seccion;
            $total_alumnos = count($censo);

            if($array_nivel_educativo[0]->id_nivel_educativo == 3){
                        for ( $i = 1 ; $i <= $total_alumnos ; $i ++) {
                                ...
                                $this->pdf->SetTitle(iconv('UTF-8','windows-1252','Boletin de Calificaciones'));
                                $this->pdf->SetLeftMargin(15);
                                $this->pdf->SetRightMargin(15);

                                $this->pdf->SetFont('Arial','U',12);
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Boletín de Calificaciones'),0,50,'C');
                                ...
                                $this->pdf->SetY(40);
                                $this->pdf->SetX(125);
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','I. Año Escolar: '.$running_year.'   Lapso: '.$lapso),0,50,'L');

                                $this->pdf->SetY(45);
                                $this->pdf->SetX(10);
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','II. Datos del Plantel: '),0,50,'J');
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Dirección: '.$uem_direccion.'                Telefono: '.$uem_telefono),0,50,'J');
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Municipio: CHACAO                Ent. Federal: MIRANDA                Zona Educativa: MIRANDA         Dtto.esc: 07'),0,50,'J');

                                $this->pdf->SetY(60);
                                $this->pdf->SetX(10);
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','III. Identificación del Curso:               Plan de Estudio: '.$nivel_educativo.'    Grado o Año: '.$grado.'          Sección: '.$seccion),0,50,'J');
                                $this->pdf->Ln(3);
                                $this->pdf->SetX(10);
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','IV. Datos de Identificación del Estudiante:'),0,50,'J');
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Apellidos y Nombres: '.$censo[$i - 1]->PrimerApellidoDelAlumno.' '.$censo[$i - 1]->SegundoApellidoDelAlumno.' '.$censo[$i - 1]->PrimerNombreDelAlumno.' '.$censo[$i - 1]->SegundoNombreDelAlumno.'          C.I: '.$letra_nacionalidad.$censo[$i - 1]->CedulaDeIdentidadDelAlumnoOCedulaEscolar),0,50,'J');
                                $this->pdf->SetX(20);

                                $yLocation = 108;

                                $subjects = $this->db->get_where('asignatura' , array('id_grado'=>$param2))->result_array();
                                foreach ($subjects as $materia) {
                                        $this->pdf->SetY($yLocation);
                                        $this->pdf->SetX(10);
                                        $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252',$materia['abreviacion_boletin']),0,50,'J');
                                        $yLocation = $yLocation + 5;
                                        if ($i < $total_alumnos){
                                            $this->pdf->Line(10, $yLocation, 207, $yLocation); //Linea Horizontal
                                        }
                                }
                                $promedio_calificaciones_lapso = '';
                                $promedio_calificaciones_lapso_fecha = '';
                                $promedio_calificaciones_seccion_lapso = '';
                                $promedio_calificaciones_seccion_lapso_fecha = '';
                                $posicion_alumno = '';
                                $definitiva_year = '';

                                $this->pdf->SetY(($yLocation + 2));
                                $this->pdf->SetX(10);
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','OBSERVACIONES:'),0,50,'J');

                                $this->pdf->SetY(($yLocation + 2));
                                $this->pdf->SetX(10);
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Definitiva Año: '.$definitiva_year),0,50,'R');

                                $this->pdf->Line(10, ($yLocation + 28), 207, ($yLocation + 28)); //Linea Horizontal
                                $this->pdf->SetY(($yLocation + 30));
                                $this->pdf->SetX(10);
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','PROMEDIO DE CALIFICACIONES DEL ALUMNO EN ESTE LAPSO: '.$promedio_calificaciones_lapso.'                       HASTA LA FECHA: '.$promedio_calificaciones_lapso_fecha),0,50,'J');
                                $this->pdf->Line(10, ($yLocation + 38), 207, ($yLocation + 38)); //Linea Horizontal
                                $this->pdf->SetY(($yLocation + 40));
                                $this->pdf->Line(10, ($yLocation + 48), 207, ($yLocation + 48)); //Linea Horizontal
                                $this->pdf->SetX(10);
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','PROMEDIO DE CALIFICACIONES DE LA SECCIÓN EN ESTE LAPSO: '.$promedio_calificaciones_seccion_lapso.'                   HASTA LA FECHA: '.$promedio_calificaciones_seccion_lapso_fecha),0,50,'J');
                                $this->pdf->SetY(($yLocation + 50));
                                $this->pdf->SetX(10);
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','POSICION DEL ALUMNO RESPECTO A SU SECCIÓN EN ESTE LAPSO: '.$posicion_alumno),0,50,'J');

                                $this->pdf->Line(150, ($yLocation + 68), 207, ($yLocation + 68)); //Linea Horizontal
                                $this->pdf->SetY(($yLocation + 70));
                                $this->pdf->SetX(160);
                                $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Firma del Docente Guia'),0,50,'J');
                                ...
                                $this->pdf->SetX(120);
                                $this->pdf->SetFont('Arial', '', 8);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Representante'),0,50,'J');

                                $this->pdf->SetY(258);
                                $this->pdf->SetX(120);
                                $this->pdf->SetFont('Arial', '', 8);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$censo[$i - 1]->PrimerApellidoDelRepresentante.' '.$censo[$i - 1]->SegundoApellidoDelRepresentante.' '.$censo[$i - 1]->PrimerNombreDelRepresentante.' '.$censo[$i - 1]->SegundoNombreDelRepresentante),0,50,'J');

                                $this->pdf->SetY(263);
                                $this->pdf->SetX(120);
                                $this->pdf->SetFont('Arial', '', 8);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Número de C.I.: '.$censo[$i - 1]->CedulaDeIdentidadDelRepresentante),0,50,'J');

                                $this->pdf->SetY(270);
                                $this->pdf->SetX(120);
                                $this->pdf->SetFont('Arial', '', 8);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','He recibido el reporte de calificaciones de mi representado'),0,50,'J');
                                ...
                                $this->pdf->SetX(17);
                                $this->pdf->SetFont('Arial', '', 12);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','AREAS O '),0,50,'J');
                                $this->pdf->SetY(97);
                                $this->pdf->SetX(11);
                                $this->pdf->SetFont('Arial', '', 12);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','ASIGNATURAS '),0,50,'J');

                                $this->pdf->SetY(85);
                                $this->pdf->SetX(87);
                                $this->pdf->SetFont('Arial', '', 10);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','RECORD DEL LAPSO'),0,50,'J');

                                $this->pdf->SetY(85);
                                $this->pdf->SetX(175);
                                $this->pdf->SetFont('Arial', '', 10);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','LAPSOS'),0,50,'J');

                                $this->pdf->SetY(97);
                                $this->pdf->SetX(70);
                                $this->pdf->SetFont('Arial', '', 10);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','70%'),0,50,'J');

                                $this->pdf->SetY(97);
                                $this->pdf->SetX(86);
                                $this->pdf->SetFont('Arial', '', 10);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','30%'),0,50,'J');

                                $this->pdf->SetY(90);
                                $this->pdf->SetX(110);
                                $this->pdf->SetFont('Arial', '', 8);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','GRÁFICO DE RENDIMIENTO DEL ALUMNO'),0,50,'J');
                                $this->pdf->SetY(94);
                                $this->pdf->SetX(120);
                                $this->pdf->SetFont('Arial', '', 8);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','RESPECTO A SU SECCION'),0,50,'J');

                                $this->pdf->SetY(100);
                                $this->pdf->SetX(115);
                                $this->pdf->SetFont('Arial', '', 8);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','BAJO'),0,50,'J');
                                $this->pdf->SetY(100);
                                $this->pdf->SetX(135);
                                $this->pdf->SetFont('Arial', '', 8);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','MEDIO'),0,50,'J');
                                $this->pdf->SetY(100);
                                $this->pdf->SetX(155);
                                $this->pdf->SetFont('Arial', '', 8);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','ALTO'),0,50,'J');
                                ...
                                $this->pdf->SetX(10);
                                $this->pdf->SetFont('Arial', '', 6);
                                $this->pdf->RotatedText(48, 108, 'INASISTENCIAS', 90);
                                $this->pdf->RotatedText(53, 108, 'CONDUCTA', 90);
                                $this->pdf->RotatedText(58, 108, 'CALIFIC. PARCIAL 1', 90);
                                $this->pdf->RotatedText(63, 108, 'CALIFIC. PARCIAL 2', 90);
                                $this->pdf->RotatedText(68, 108, 'EVAL. CONTINUA', 90);
                                $this->pdf->RotatedText(83, 108, 'EVAL. LAPSO', 90);
                                $this->pdf->RotatedText(98, 108, 'CALIF. LAPSO', 90);
                                $this->pdf->RotatedText(103, 108, 'CONSEJO CURSO', 90);
                                $this->pdf->RotatedText(108, 108, 'PROMED. SECCION', 90);

                                $this->pdf->RotatedText(173, 108, 'DEFINIT. LAPSO 1', 90);
                                $this->pdf->RotatedText(178, 108, 'PROMEDIO SECC.', 90);
                                $this->pdf->RotatedText(183, 108, 'DEFINIT. LAPSO 2', 90);
                                $this->pdf->RotatedText(188, 108, 'PROMEDIO SECC.', 90);
                                $this->pdf->RotatedText(193, 108, 'DEFINIT. LAPSO 3', 90);
                                $this->pdf->RotatedText(198, 108, 'PROMEDIO SECC.', 90);
                                $this->pdf->SetFont('Arial', '', 8);
                                $this->pdf->RotatedText(204, 108, 'CALIF. DEFINITIVA', 90);

                                $this->pdf->SetX(10);
                                $this->pdf->RoundedRect(10, 82, 197, ($yLocation - 82), 2, '', '');
                                $this->pdf->Line(45, 82, 45, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(50, 87, 50, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(55, 87, 55, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(60, 87, 60, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(65, 87, 65, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(70, 87, 70, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(80, 87, 80, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(85, 87, 85, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(95, 87, 95, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(100, 87, 100, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(105, 87, 105, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(110, 87, 110, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(130, 96, 130, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(150, 96, 150, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(170, 82, 170, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(175, 87, 175, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(180, 87, 180, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(185, 87, 185, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(190, 87, 190, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(195, 87, 195, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(200, 82, 200, ($yLocation )); //Linea Vertical
                                $this->pdf->Line(120, 102, 120, 108); //Linea Vertical
                                $this->pdf->Line(140, 102, 140, 108); //Linea Vertical
                                $this->pdf->Line(160, 102, 160, 108); //Linea Vertical
                                $this->pdf->Line(10, 108, 207, 108); //Linea Horizontal
                                $this->pdf->Line(45, 87, 200, 87); //Linea Horizontal
                                $this->pdf->Line(110, 96, 170, 96); //Linea Horizontal
                                $this->pdf->Line(110, 102, 170, 102); //Linea Horizontal
                        }
            }else{
                        for ( $i = 1 ; $i <= $total_alumnos ; $i ++) {
                                // Agregamos una página
    ...
    function proyecto_pedagogico($param1='')
    {
            if ($this->session->userdata('admin_login') != 1)
                redirect(base_url(), 'refresh');

            $this->load->model('VistaNivelEducativoSeccion');
            $this->load->library('header_censo/pdflandscape');

            //Seccion a mostrar
            $id_seccion = $param1;
            $id_school = $this->config->item('id_school');
            $running_year = $this->db->get_where('configuraciones' , array('nombre'=>'running_year'))->row()->valor;
            $exams_section = $this->db->get_where('projectos', array('id_seccion' => $id_seccion))->result_array();
            $lapso_activo = $exams_section[0]['class_lapso'];
            $total_exams = count($exams_section);
            $partes = ceil($total_exams / 6);
            $array_nivel_educativo = VistaNivelEducativoSeccion::where('id_escuela', '=', $id_school)->where('id_seccion','=', $id_seccion)->get();
            $seccion = $array_nivel_educativo[0]->nombre_seccion;
            $asignatura = '';
            $docente = $this->crud_model->get_teacher_name($exams_section[0]['teacher_id']);
            $countItems = 1;
            $this->pdf = new Pdflandscape('P','mm','Legal');
            ...
            for ($i=0; $i < $partes; $i++) {
                    ...
                    $this->pdf->RoundedRect(10, 37, 80, 30, 2, '', '');
                    $this->pdf->Line(50, 37, 50, 67);
                    $this->pdf->Line(10, 43, 90, 43);
                    $this->pdf->Line(10, 49, 90, 49);
                    $this->pdf->Line(10, 55, 90, 55);
                    $this->pdf->Line(10, 61, 90, 61);

                    $this->pdf->SetY(40);
                    $this->pdf->SetX(15);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Año escolar:'),0,50,'J');

                    $this->pdf->SetY(46);
                    $this->pdf->SetX(15);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Lapso:'),0,50,'J');

                    $this->pdf->SetY(52);
                    $this->pdf->SetX(15);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Asignatura:'),0,50,'J');

                    $this->pdf->SetY(58);
                    $this->pdf->SetX(15);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Año y Sección:'),0,50,'J');
                    ...
                    $this->pdf->SetY(40);
                    $this->pdf->SetX(55);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$running_year),0,50,'J');

                    $this->pdf->SetY(46);
                    $this->pdf->SetX(55);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$lapso_activo),0,50,'J');
                    ...
                    $this->pdf->SetY(58);
                    $this->pdf->SetX(55);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$seccion),0,50,'J');
                    ...
                    $this->pdf->RoundedRect(10, 70, 335, 140, 2, '', '');
                    $this->pdf->Line(10, 76, 345, 76); //Linea Horizontal
                    $this->pdf->Line(10, 84, 345, 84); //Linea Horizontal
                    $this->pdf->SetY(73);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','PLANIFICACIÓN DE PROYECTO PEDAGOGICO'),0,50,'C');
                    $this->pdf->SetFont('Arial', 'B', 8);
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(11);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Nº'),0,50,'J');
                    $this->pdf->Line(17, 76, 17, 210); //Linea Vertical
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(28);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Objetivo'),0,50,'J');
                    $this->pdf->Line(60, 76, 60, 210); //Linea Vertical
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(75);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Diagnóstico'),0,50,'J');
                    $this->pdf->Line(105, 76, 105, 210); //Linea Vertical
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(120);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Propósito'),0,50,'J');
                    $this->pdf->Line(150, 76, 150, 210); //Linea Vertical
                    $this->pdf->SetY(79);
                    $this->pdf->SetX(169);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Actividades'),0,50,'J');
                    $this->pdf->SetY(82);
                    $this->pdf->SetX(170);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Didacticas'),0,50,'J');
                    $this->pdf->Line(210, 76, 210, 210); //Linea Vertical
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(225);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Técnicas'),0,50,'J');
                    $this->pdf->Line(255, 76, 255, 210); //Linea Vertical
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(268);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Actividades'),0,50,'J');
                    $this->pdf->Line(300, 76, 300, 210); //Linea Vertical
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(315);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Recursos'),0,50,'J');

                    $locationLineY = 110;
                    $locationTextY = 99;

                    for ($j=0; $j < 5; $j++) {
                        if ($countItems <= $total_exams ) {
                            $this->pdf->SetFont('Arial', 'B', 8);
                            $this->pdf->SetY($locationTextY - 7);
                            $this->pdf->SetX(11);
                            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$countItems),0,50,'J');
                            $this->pdf->SetFont('Arial', '', 7);
                            $this->pdf->SetY($locationTextY - 12);
                            $this->pdf->SetX(18);
                            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$exams_section[$countItems - 1]['objetivo']),0,50,'J');
                            $this->pdf->SetY($locationTextY - 12);
                            $this->pdf->SetX(62);
                            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$exams_section[$countItems - 1]['name_texareaDiag']),0,50,'J');
                            $this->pdf->SetY($locationTextY - 12);
                            $this->pdf->SetX(107);
                            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$exams_section[$countItems - 1]['name_texareaPropo']),0,50,'J');
                            $this->pdf->SetY($locationTextY - 12);
                            $this->pdf->SetX(152);
                            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$exams_section[$countItems - 1]['name_texareaActi']),0,50,'J');
                            $tecnicas_exam = $this->db->get_where('tecnicas_projecto', array('id_exam' => $exams_section[$countItems - 1]['id_projecto']))->result_array();
                            $locationTecnica = $locationTextY - 12;
                            foreach ($tecnicas_exam as $tecnica) {
                                $this->pdf->SetY($locationTecnica);
                                $this->pdf->SetX(212);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$this->crud_model->get_type_name_by_id('tecnicas_planificacion_media' , $tecnica['id_tecnica'])),0,50,'J');
                                $locationTecnica = $locationTecnica + 5;
                            }
                            $actividades_exam = $this->db->get_where('actividades_projecto', array('id_exam' => $exams_section[$countItems - 1]['id_projecto']))->result_array();
                            $locationActividad = $locationTextY - 12;
                            foreach ($actividades_exam as $actividad) {
                                $this->pdf->SetY($locationActividad);
                                $this->pdf->SetX(257);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$this->crud_model->get_type_name_by_id('actividades_planificacion_media' , $actividad['id_actividad'])),0,50,'J');
                                $locationActividad = $locationActividad + 5;
                            }
                            $recursos_exam = $this->db->get_where('recursos_projecto', array('id_exam' => $exams_section[$countItems - 1]['id_projecto']))->result_array();
                            $locationRecurso = $locationTextY - 12;
                            foreach ($recursos_exam as $recurso) {
                                $this->pdf->SetY($locationRecurso);
                                $this->pdf->SetX(302);
                                $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$this->crud_model->get_type_name_by_id('recursos_planificacion_media' , $recurso['id_recurso'])),0,50,'J');
                                $locationRecurso = $locationRecurso + 5;
                            }


                            $this->pdf->Line(10, $locationLineY, 345, $locationLineY);
                            $locationLineY = $locationLineY + 25;
                            $locationTextY = $locationTextY + 25;
    ...
    function plan_evaluacion($param1='')
    {
            if ($this->session->userdata('admin_login') != 1)
                redirect(base_url(), 'refresh');
            ...
            $id_school = $this->config->item('id_school');
            $running_year = $this->db->get_where('configuraciones' , array('nombre'=>'running_year'))->row()->valor;
            $exams_section = $this->db->get_where('exam', array('id_seccion' => $id_seccion))->result_array();
            $lapso_activo = $exams_section[0]['class_lapso'];
            $total_exams = count($exams_section);
            $partes = ceil($total_exams / 6);
            $array_nivel_educativo = VistaNivelEducativoSeccion::where('id_escuela', '=', $id_school)->where('id_seccion','=', $id_seccion)->get();
            ...
            for ($i=0; $i < $partes; $i++) {
                    ...
                    $this->pdf->SetY(73);
                    $this->pdf->SetX(70);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','PLANIFICACIÓN'),0,50,'J');
                    $this->pdf->SetY(73);
                    $this->pdf->SetX(265);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','EVALUACIÓN'),0,50,'J');
                    $this->pdf->SetFont('Arial', 'B', 8);
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(11);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Nº'),0,50,'J');
                    ...
                    $this->pdf->SetX(28);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Objetivo'),0,50,'J');
                    $this->pdf->Line(52, 76, 52, 210); //Linea Vertical
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(63);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Contenido'),0,50,'J');
                    $this->pdf->Line(90, 76, 90, 210); //Linea Vertical
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(100);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Técnicas'),0,50,'J');
                    $this->pdf->Line(120, 76, 120, 210); //Linea Vertical
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(128);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Actividades'),0,50,'J');
                    $this->pdf->Line(152, 76, 152, 210); //Linea Vertical
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(160);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Recursos'),0,50,'J');
                    $this->pdf->Line(185, 70, 185, 210); //Linea Vertical
                    $this->pdf->SetY(79);
                    $this->pdf->SetX(195);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Actividad de'),0,50,'J');
                    $this->pdf->SetY(82);
                    $this->pdf->SetX(196);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','evaluacion'),0,50,'J');
                    $this->pdf->Line(220, 76, 220, 210); //Linea Vertical
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(228);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Instrumento'),0,50,'J');
                    $this->pdf->Line(255, 76, 255, 210); //Linea Vertical
                    $this->pdf->SetY(78);
                    $this->pdf->SetX(265);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Criterios a evaluar'),0,50,'J');
                    $this->pdf->SetY(82);
                    $this->pdf->SetX(265);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Aspectos'),0,50,'J');
                    $this->pdf->Line(287, 80, 287, 210); //Linea Vertical
                    $this->pdf->SetY(82);
                    $this->pdf->SetX(288);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Puntaje'),0,50,'J');
                    $this->pdf->Line(300, 76, 300, 210); //Linea Vertical
                    $this->pdf->SetY(78);
                    $this->pdf->SetX(303);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Ponderación'),0,50,'J');
                    $this->pdf->Line(255, 80, 325, 80); //Linea Horizontal
                    $this->pdf->SetY(82);
                    $this->pdf->SetX(303);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','%'),0,50,'J');
                    $this->pdf->Line(312, 80, 312, 210); //Linea Vertical
                    $this->pdf->SetY(82);
                    $this->pdf->SetX(315);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Pts'),0,50,'J');
                    $this->pdf->Line(325, 76, 325, 210); //Linea Vertical
                    $this->pdf->SetY(80);
                    $this->pdf->SetX(330);
                    $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Fecha'),0,50,'J');
                    ...
                    for ($j=0; $j < 5; $j++) {
                        if ($countItems <= $total_exams ) {
                            ...
                            $this->pdf->SetY($locationTextY - 12);
                            $this->pdf->SetX(18);
                            $this->pdf->MultiCell(35,3,iconv('UTF-8','windows-1252',$exams_section[$countItems - 1]['objetivo']),0,'J',0);
                            $this->pdf->SetY($locationTextY - 12);
                            $this->pdf->SetX(53);
                            $this->pdf->MultiCell(37,3,iconv('UTF-8','windows-1252',$exams_section[$countItems - 1]['contenido']),0,'J',0);
                            $tecnicas_exam = $this->db->get_where('tecnicas_exam', array('id_exam' => $exams_section[$countItems - 1]['exam_id']))->result_array();
                            $locationTecnica = $locationTextY - 12;
                            foreach ($tecnicas_exam as $tecnica) {
                                $this->pdf->SetY($locationTecnica);
                                $this->pdf->SetX(91);
                            ...
                            $actividades_exam = $this->db->get_where('actividades_exam', array('id_exam' => $exams_section[$countItems - 1]['exam_id']))->result_array();
                            $locationActividad = $locationTextY - 12;
                            foreach ($actividades_exam as $actividad) {
                                $this->pdf->SetY($locationActividad);
                                $this->pdf->SetX(121);
                            ...
                            $recursos_exam = $this->db->get_where('recursos_exam', array('id_exam' => $exams_section[$countItems - 1]['exam_id']))->result_array();
                            $locationRecurso = $locationTextY - 12;
                            foreach ($recursos_exam as $recurso) {
                                $this->pdf->SetY($locationRecurso);
                                $this->pdf->SetX(153);
                            ...
                            $this->pdf->SetY($locationTextY - 7);
                            $this->pdf->SetX(186);
                            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$this->crud_model->get_type_name_by_id('evaluacion_planificacion_media' , $exams_section[$countItems - 1]['id_evaluacion'])),0,50,'J');
                            $this->pdf->SetY($locationTextY - 7);
                            $this->pdf->SetX(220);
                            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$this->crud_model->get_type_name_by_id('instrumento_planificacion_media' , $exams_section[$countItems - 1]['id_instrumento'])),0,50,'J');
                            $this->pdf->SetY($locationTextY - 7);
                            $this->pdf->SetX(292);
                            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',($exams_section[$countItems - 1]['valor_ponderacion'] / 5)),0,50,'J');
                            $this->pdf->SetY($locationTextY - 7);
                            $this->pdf->SetX(304);
                            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',($exams_section[$countItems - 1]['valor_ponderacion'])),0,50,'J');
                            $this->pdf->SetY($locationTextY - 7);
                            $this->pdf->SetX(316);
                            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',($exams_section[$countItems - 1]['valor_ponderacion'] / 5)),0,50,'J');
                            $this->pdf->SetY($locationTextY - 7);
                            $this->pdf->SetX(327);
                            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$exams_section[$countItems - 1]['fecha_examen']),0,50,'J');
    ...
    function resumen_plan_evaluacion($param1='')
    {
            if ($this->session->userdata('admin_login') != 1)
                redirect(base_url(), 'refresh');
            ...
            $id_school = $this->config->item('id_school');
            $running_year = $this->db->get_where('configuraciones' , array('nombre'=>'running_year'))->row()->valor;
            $lapso_activo = $this->db->get_where('configuraciones' , array('nombre'=>'running_year'))->row()->valor;
            $exams_section = $this->db->get_where('exam', array('id_seccion' => $id_seccion))->result_array();
            $array_nivel_educativo = VistaNivelEducativoSeccion::where('id_escuela', '=', $id_school)->where('id_seccion','=', $id_seccion)->get();
            $seccion = $array_nivel_educativo[0]->nombre_seccion;

            $asignatura = $this->db->get_where('configuraciones' , array('nombre'=>'running_year'))->row()->valor;
            $docente = $this->db->get_where('configuraciones' , array('nombre'=>'running_year'))->row()->valor;
            $countItems = 1;
            $this->pdf = new Pdf('P','mm','A4');
            ...
            $this->pdf->SetY(60);
            $this->pdf->SetX(15);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Profesor: '),0,50,'J');
            $this->pdf->SetY(60);
            $this->pdf->SetX(100);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Año y Sección: '),0,50,'J');
            $this->pdf->SetY(70);
            ...
            $this->pdf->Ln(15);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','RESUMEN DE PLAN DE EVALUACIÓN'),0,50,'C');

            $this->pdf->RoundedRect(20, 100, 170, 80, 2, '', '');
            $this->pdf->Line(50, 100, 50, 180);
            $this->pdf->Line(130, 100, 130, 180);
            $this->pdf->Line(155, 100, 155, 180);
            $this->pdf->Line(20, 108, 190, 108);

            $this->pdf->SetY(104);
            $this->pdf->SetX(22);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','Nº OBJETIVO'),0,50,'J');
            $this->pdf->SetY(104);
            $this->pdf->SetX(80);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','ACTIVIDAD'),0,50,'J');
            $this->pdf->SetY(104);
            $this->pdf->SetX(135);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','FECHA'),0,50,'J');
            $this->pdf->SetY(104);
            ...
            $locationTextY = 112;
            $countItems = 1;
            foreach ($exams_section as $exam) {
                        $this->pdf->SetFont('Arial', 'B', 8);
                        $this->pdf->SetY($locationTextY );
                        $this->pdf->SetX(32);
                        $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$countItems),0,50,'J');
                        $this->pdf->SetFont('Helvetica', '', 9);
                        $this->pdf->SetY($locationTextY);
                        $this->pdf->SetX(53);
                        $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$this->crud_model->get_type_name_by_id('evaluacion_planificacion_media' , $exam['id_evaluacion'])),0,50,'J');
                        $this->pdf->SetY($locationTextY);
                        $this->pdf->SetX(133);
                        $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',$exam['fecha_examen']),0,50,'J');
                        $this->pdf->SetY($locationTextY);
                        $this->pdf->SetX(170);
                        $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252',($exam['valor_ponderacion'])),0,50,'J');
                        $this->pdf->Line(20, $locationLineY, 190, $locationLineY);
                        $locationLineY = $locationLineY + 7;
                        $locationTextY = $locationTextY + 7;
                        $countItems = $countItems + 1;
            }

            $this->pdf->SetY(200);
            $this->pdf->SetX(25);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','FECHA DE ENTREGA :    /       /           '),0,50,'J');

            $this->pdf->SetY(200);
            $this->pdf->SetX(110);
            $this->pdf->Cell(0,0,iconv('UTF-8','windows-1252','FIRMA DEL PROFESOR:_______________________'),0,50,'J');
