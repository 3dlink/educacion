...
class Mobile extends CI_Controller
{
    ...
    function get_system_info() {
        ...
        $response['system_name']    =   $this->db->get_where('configuraciones' , array('nombre'=>'nombre_sistema'))->row()->valor;
        echo json_encode($response);
    }
    ...
    function login() {
        ...
        if(count($usuario) > 0) {
            ...
            $response['login_user_id']  =   $usuario['id_usuario'];
            $response['name']           =   $usuario['usuario'];
