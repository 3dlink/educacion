<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
  ...
  class Resumen extends CI_Controller {
    ...
    public function index()
    {
      ...
      $this->pdf->Cell(0,5,iconv('UTF-8','windows-1252','(RESUMEN)'),0,50,'C');
      ...
      $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Residente del Municipio:     '.$residente.
            '          Cupos a solicitar:     '.$cupos_solicitar.'          Grado a cursar:     '.$cupos_solicitar.
      ...
      $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Ingreso mensual:     '.$ingreso_mensual_representante.
            '          Jornada laboral:     '.$jornada_laboral_representante.'          Diversidad funcional:     '.$diversidad_representante),0,50,'L');
      ...
      $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','Datos de la vivienda:     '.$datos_vivienda),0,50,'L');
      ...
      $this->pdf->Ln(1);
      $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','AV. MOHEDANO CRUCE CON CALLE LA PAZ'),0,50,'L');
      $this->pdf->SetFont('Arial', 'B', 8);
      $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','+ 58 212 - 266.4822'),0,50,'L');
      $this->pdf->Cell(0,4,iconv('UTF-8','windows-1252','uemabello@gmail.com'),0,50,'L');
