...
<head>
	...
	<?php
		if($page_name == 'census_edit' || $page_name == 'census_new'
			|| $page_name == 'anamnesis_ps' || $page_name == 'anamnesis_psc'
			|| $page_name == 'anamnesis_ts' || $page_name == 'student_new'
			|| $page_name == 'student_edit' || $page_name == 'student_add'
			|| $page_name == 'anamnesis_to' || $page_name == 'anamnesis_ps'
			|| $page_name == 'anamnesis_tl' || $page_name == 'anamnesis_psc'
			|| $page_name == 'anamnesis_ts'){
	?>
