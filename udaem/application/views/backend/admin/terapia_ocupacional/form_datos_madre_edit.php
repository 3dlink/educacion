    ...
    <div class="box-content main" style="<?php echo ($row['ParentescoConElAlumno']=='MADRE')?'display:none':'' ?>">
        <form id="form-datos-madre" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <button type="button" id="anterior-datos-madre-to" class="btn btn-info">Anterior</button>
                </div>
                <div class="col-sm-2"></div>
                <div class="col-sm-4">
                    <button type="button" id="siguiente-datos-madre-to" class="btn btn-info">Siguiente</button>
                </div>
            </div>
        </form>
    </div>
...
<div id="madre-elegida" class="box-content madre-elegida-repre" style="<?php echo ($row['ParentescoConElAlumno']=='MADRE')?'':'display:none' ?>">
    ...
    <div class="form-horizontal form-groups-bordered form-censo">
            <div class="form-group">
                <div class="col-sm-2"></div>
                <div class="col-sm-4">
                    <button type="button" id="anterior-datos-madre-dos-to" class="btn btn-info">Anterior</button>
                </div>
                <div class="col-sm-2"></div>
                <div class="col-sm-4">
                    <button type="button" id="siguiente-datos-madre-dos-to" class="btn btn-info">Siguiente</button>
                </div>
            </div>
    </div>
</div>
