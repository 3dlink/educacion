    ...
    <div class="box-content">
        ...
        <form id="form-datos-representante" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <button type="button" id="anterior-datos-representante-to" class="btn btn-info">Anterior</button>
                </div>
                <div class="col-sm-2"></div>
                <div class="col-sm-4">
                    <button type="button" id="siguiente-datos-representante-to" class="btn btn-info">Siguiente</button>
                </div>
            </div>
        </form>
    </div>
