    ...
    <div class="box-content">
        <form id="form-datos-saludalu" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label><input type="radio" required class="form-control" name="FactorRh" value="+">+</label>
                    <label><input type="radio" class="form-control" name="FactorRh" value="-">-</label>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label><input type="radio" required class="form-control" name="TipoDeParto" value="NORMAL">Normal</label>
