...
var madreFechaNac = jQuery('#madreFechaNac').attr('name');
	...
	jQuery('#madreFechaNac').blur(function(e) {
...
jQuery('#siguiente-datos-madre-dos').click(function(e){
...
jQuery('#anterior-datos-madre-dos').click(function(e){
	jQuery("#tab-datos-generales a").trigger( "click" );
});

jQuery( '.madre-viva' ).change(function(e) {
	if (this.value == '1') {
...
jQuery( '.tipoNacMadre' ).change(function(e) {
...
jQuery( '.radio-madreMismaResiAlu' ).change(function(e) {
	if (this.value == '0') {
...
jQuery( '.madreTrabaja' ).change(function(e) {
	if (this.value == '1') {
