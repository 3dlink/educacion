            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                  <select class="form-control" id="aluGradoACursar" name="GradoACursar" required>
                    <option value="0" selected="selected" disabled="disabled">Seleccione...</option>
                    <?php foreach ($grados_censo as $grado_lista){ ?>
                        <option value="<?php echo $grado_lista['id_censo_grado']?>" <?php echo ($grado_cursar==$grado_lista['id_censo_grado'])?'selected="selected"':'' ?> > <?php echo $grado_lista['grado']?></option>
                    <?php } ?>
                  </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                     ...
                     <input type="hidden" name="UniDePrefJuanDio" value="0" >
                      <label><input type="checkbox" id="UniDePrefJuanDio" name="UniDePrefJuanDio" class="requireUniEdu" value="1" >UEM Juan de Dios Guanche</label>
                    </div>
                    ...
                    <div class="checkbox">
                      ...
                      <label><input type="checkbox" id="UniDePrefCarlos" name="UniDePrefCarlos" class="requireUniEdu" value="1" >UEMI Carlos Soublette</label>
                    </div>
                </div>
            </div>
            <div class="form-group">
