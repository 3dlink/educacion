			...
			?>
				<li class="<?php if ($row['id_grado'] == $class_id) echo 'active';?>">
					<a href="<?php echo base_url().$this->session->userdata('login_type');?>/section/<?php echo $row['id_nivel_educativo'];?>/<?php echo $row['id_grado'];?>">
						...
						<?php echo "Grado" ?> <?php echo $row['nombre_grado'];?>
					</a>
				</li>
			<?php endforeach;?>
			</ul>
					...
					<table class="table table-bordered responsive">
						...
						?>
							<tr>
								...
								<td>
									<?php
										echo $this->db->get_where('teacher' , array('teacher_id' => 1))->row()->name;
									?>
								</td>
								<td>
									<div class="btn-group">
		                                ...
		                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
		                                    ...
		                                    <!-- EDITING LINK -->
		                                    <li>
		                                        <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/section_edit/<?php echo $row['id_seccion'];?>');">
		                                    ...
		                                    <!-- DELETION LINK -->
		                                    <li>
		                                        <a href="#" onclick="confirm_modal('<?php echo base_url().$this->session->userdata('login_type');?>/sections/delete/<?php echo $row['id_seccion'];?>');">
