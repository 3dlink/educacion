<hr />
	<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
		...
		<tbody>
        	<form method="post" action="<?php echo base_url().$this->session->userdata('login_type');?>/attendance_selector" class="form">
            	<tr class="gradeA">
                    <td>
    ...
    <div class="row">
        <div class="col-sm-offset-4 col-sm-4">
            ...
            <div class="tile-stats tile-white-gray">
                ...
                <h3>Asistencia del grado <?php echo ($class_id);?></h3>
...
<form method="post"
    action="<?php echo base_url();?>index.php?admin/manage_attendance/<?php echo $date.'/'.$month.'/'.$year.'/'.$nivel_educativo.'/'.$class_id;?>">
        <div class="col-sm-offset-3 col-md-6">
            <table  class="table table-bordered">
        		<thead>
        			<tr class="gradeA">
