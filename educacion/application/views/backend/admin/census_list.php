    ...
    $estudiantes = Puntaje_censo::orderBy('id_censo')->get();
                ...
                foreach($estudiantes as $row):?>
                    <?php
                        ...
                        $nacimiento = $dia_nacimiento.'/'.$mes_nacimiento.'/'.$ano_nacimiento;
                            ...
                            $grado_cursar = Censo_grado::where('id_censo_grado', '=', $row['grado_cursar'])->get();
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <!-- VALIDATION LINK -->
                                    <li>
                                        <a href="#" onclick="validate_modal('<?php echo base_url().$this->session->userdata('login_type');?>/census_list/validate/<?php echo $id_censo; ?>');">
                                    ...
                                    <!-- DELETION LINK -->
                                    <li>
                                        <a href="#" onclick="delete_modal('<?php echo base_url().$this->session->userdata('login_type');?>/census_list/delete/<?php echo $id_censo; ?>');">
