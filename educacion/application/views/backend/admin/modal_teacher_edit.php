            ...
            <div class="panel-body">
                ...
                <?php echo form_open(base_url().'admin/teacher/edit/'.$param2 , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" required minlength="" maxlength="8" class="form-control" name="cedula_identidad" data-validate="required" data-message-required="<?php echo "Requerido"?>" value="<?php echo $row['cedula_identidad']; ?>" autofocus>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="id_cargo" class="form-control" >
                               ...
                               foreach($cargos as $row_cargo):?>
                                <option value="<?php echo $row_cargo['cargo_id'];?>"
                                    <?php if($row_cargo['cargo_id'] == $row['id_cargo']) echo 'selected="selected"';?>>
                                        <?php echo $row_cargo['name'];?>
                                            </option>
                                <?php endforeach;?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="id_escuela" class="form-control" >
                               ...
                               foreach($escuelas as $row_escuela):?>
                                <option value="<?php echo $row_escuela['id_escuela'];?>"
                                    <?php if($row_escuela['id_escuela']==$row['id_escuela']) echo 'selected="selected"';?>>
                                        <?php echo $row_escuela['nombre_escuela'];?>
                                            </option>
                                <?php endforeach;?>
                            </select>
                        </div>
