<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class Pdf extends FPDF {
      ...
      public function Header(){
          ...
          $logo_escuela = "uploads/scude_guanche.jpg";
          $codigo_dea = "CODIGO: DEA S3648D1507";

          $this->SetFont('Arial','B',8);
          $this->Cell(30);
          $this->Cell(40, 40, $this->Image($logo_escuela, 10, 10, 25), 0, 0, 'L', false );
          $this->Cell(-85);
          ...
          $this->Cell(0,3,iconv('UTF-8','windows-1252','"Juan de Dios Guanche"'),0,50,'C');
          $this->Cell(0);
          $this->Cell(40, 40, $this->Image($logo_chacao, 170, 10, 33), 0, 0, 'C', false );
          $this->Ln(10);
          $this->SetFont('Arial','B',8);
      ...
      function Footer()
      {
          ...
          $this->Cell(0,10,iconv('UTF-8','windows-1252','Página ').$this->PageNo(). " de {totalPages}",0,0,'R');
      }
    }
?>