...
function AjaxReportEdit(link,datosForm,tipo,sincronizacion,funcion_respuesta) {
    tipo = tipo || "POST";
    var url_base = '';
...
function AjaxReportEmpty(link,datosForm,tipo,sincronizacion,funcion_respuesta) {
    tipo = tipo || "POST";
    var url_base = '';
