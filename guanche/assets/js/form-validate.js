      ...
      ajax(
        ...
        function(data) {
          ...
          if(status === 1) {
            ...
            $("#carnetID_Inscripcion").val(data.id_inscripcion);
...
$("#record_types").change(function(){
    ...
    if(valor == 0){
     ...
     else if(valor == 1)
     {
         ...
         jQuery('#linkEnviarConstancia').css('display','block');
         jQuery('#linkEnviarConstanciaAsistencia').css('display','none');
         jQuery('#linkEnviarConstanciaTramites').css('display','none');
         jQuery('#linkEnviarConstanciaConvovatoria').css('display','none');
     }
     else if(valor == 2)
     {
         jQuery('#linkConstancia').css('display','block');
     ...
     else if(valor == 3)
     {
         ...
         jQuery('#linkEnviarConstancia').css('display','none');
         jQuery('#linkEnviarConstanciaAsistencia').css('display','block');
         jQuery('#linkEnviarConstanciaTramites').css('display','none');
         jQuery('#linkEnviarConstanciaConvovatoria').css('display','none');
     }
     else if(valor == 4)
     {
         ...
         jQuery('#linkEnviarConstancia').css('display','none');
         jQuery('#linkEnviarConstanciaAsistencia').css('display','none');
         jQuery('#linkEnviarConstanciaTramites').css('display','block');
         jQuery('#linkEnviarConstanciaConvovatoria').css('display','none');
     }
     else if(valor == 5)
     {
         ...
         jQuery('#linkEnviarConstanciaAsistencia').css('display','none');
         jQuery('#linkEnviarConstanciaTramites').css('display','none');
         jQuery('#linkEnviarConstanciaConvovatoria').css('display','block');
     }
});
