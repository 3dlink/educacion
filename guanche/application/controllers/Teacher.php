...
//                }
    ...
    function get_class_section($class_id)
    {
        ...
        $sections = $this->db->get_where('vescuela_seccion' , array('id_grado' => $class_id, 'id_escuela' => $id_school))->result_array();
    ...
    function exam($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        $classes_array = VistaNivelEducativoSeccion::whereIn('id_seccion', $section_teacher)->get();
