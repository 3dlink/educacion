        ...
        <div class="tab-content">
                        ...
                        <tr>
                            ...
                            <?php
                                if($id_nivel_educativo == 3){
                                    ...
                                    <?php $teacher = $this->crud_model->get_type_name_by_id('teacher', $row['teacher_id']); ?>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url().$this->session->userdata('login_type').'/classes/'.$id_nivel_educativo.'/create/' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
