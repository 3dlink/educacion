...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <?php echo form_open(base_url().$this->session->userdata('login_type').'/sections/'.$param2.'/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
