        ...
        <div class="form-group">
            <div class="col-sm-12" id="study-record" style="text-align: center; ">
                <div class="title-record" style="margin:50px auto 40px;">
                    <strong><h4>CONSTANCIA DE ASISTENCIA</h4></strong>
                </div>
                <div style="text-align: justify;">
                    <p style="font-size: 11px !important; line-height: 200%;">
                         Quien suscribe, <?php echo $escuela->director->primer_nombre.' '.$escuela->director->segundo_nombre.', '.$escuela->director->primer_apellido.' '.$escuela->director->segundo_apellido; ?>,  C.I:<?php echo $escuela->director->cedula_identidad; ?> Director (a), hace  constar que el ciudadano (a):  <?php echo $estudiante[0]->persona->primer_nombre.' '.$estudiante[0]->persona->segundo_nombre.', '.$estudiante[0]->persona->primer_apellido.' '.$estudiante[0]->persona->segundo_apellido; ?>  titular de la Cédula de Identidad N°: <?php echo $cedula_estudiante; ?> Representante del  alumno (a): <?php echo $estudiante[0]->persona->primer_nombre.' '.$estudiante[0]->persona->segundo_nombre.', '.$estudiante[0]->persona->primer_apellido.' '.$estudiante[0]->persona->segundo_apellido; ?>, asistió a la  institución, en fecha  <?php echo $porciones[0] ?> en el horario comprendido entre las <?php echo $porciones[1] ?> hasta las <?php echo $porciones[2] ?> con motivo de atender asuntos relacionados con su representado.
                    </p>
...
<script type="text/javascript">
    ...
    function PrintElem(id_estudent, data_one, data_two, data_three)
    {
        var url = window.location.href +'/'+ '../../Constancia/constanciaAsistencia?std='+id_estudent+'&tone='+data_one+'&ttwo='+data_two+'&tfor='+data_three ;
