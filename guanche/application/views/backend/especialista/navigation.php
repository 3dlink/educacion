            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'menu') echo 'active'; ?> ">
                    ...
                    <ul>
                        ...
                        <li class="<?php if ($page_name == 'menu') echo 'active'; ?> ">
                            <a href="<?php echo base_url().$this->session->userdata('login_type') ?>/menu.tkml">
                                <span><i class="entypo-dot"></i> <?php echo "TO"?></span>
                            </a>
                        </li>
                    </ul>
                    <ul>
                        ...
                        <li class="<?php if ($page_name == 'menu') echo 'active'; ?> ">
                            <a href="<?php echo base_url().$this->session->userdata('login_type') ?>/menu.tkml">
                                <span><i class="entypo-dot"></i> <?php echo "TS"?></span>
                            </a>
                        </li>
                    </ul>
                    <ul>
                        ...
                        <li class="<?php if ($page_name == 'menu') echo 'active'; ?> ">
                            <a href="<?php echo base_url().$this->session->userdata('login_type') ?>/menu.tkml">
                                <span><i class="entypo-dot"></i> <?php echo "TL"?></span>
                            </a>
                        </li>
                    </ul>
                    <ul>
                        ...
                        <li class="<?php if ($page_name == 'menu') echo 'active'; ?> ">
                            <a href="<?php echo base_url().$this->session->userdata('login_type') ?>/menu.tkml">
                                <span><i class="entypo-dot"></i> <?php echo "PS"?></span>
                            </a>
                        </li>
                    </ul>
                    <ul>
                        ...
                        <li class="<?php if ($page_name == 'menu') echo 'active'; ?> ">
                            <a href="<?php echo base_url().$this->session->userdata('login_type') ?>/menu.tkml">
                                <span><i class="entypo-dot"></i> <?php echo "PSC"?></span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'select_report') echo 'active'; ?> ">
                    <a href="<?php echo base_url().$this->session->userdata('login_type') ?>/select_report.tkml" >
                        <span><i class="entypo-dot"></i> <?php echo "Reportes PDF"?></span>
                    </a>
                </li>
