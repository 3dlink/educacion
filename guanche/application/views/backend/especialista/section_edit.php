...
<?php echo form_open(base_url().$this->session->userdata('login_type').'/sections/'.$param3.'/edit/' . $row['id_seccion'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
