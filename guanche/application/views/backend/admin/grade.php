		...
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered datatable" id="table_export">
                	<thead>
                		<tr>
                    		<th><div>#</div></th>
                    		<th><div><?php echo "Nombre del Grado" ?></div></th>
                    		<th><div><?php echo "Puntaje" ?></div></th>
                    		<th><div><?php echo "Desde" ?></div></th>
                    		<th><div><?php echo "Hasta" ?></div></th>
                        ...
                        <tr>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <!-- DELETION LINK -->
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo base_url().$this->session->userdata('login_type');?>/grade/delete/<?php echo $row['grade_id'];?>');">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url().$this->session->userdata('login_type').'/grade/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo "Puntaje"?></label>
                                <div class="col-sm-5 controls">
