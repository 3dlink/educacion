...
-- Tiempo de generación: 28-04-2016 a las 02:25:18
-- Versión del servidor: 5.5.42-log
...
--
CREATE DATABASE IF NOT EXISTS `tekkoa_xcolar` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `tekkoa_xcolar`;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='Grados usados en el censo (e.g mostrados en un select).';
...
CREATE TABLE IF NOT EXISTS `configuraciones` (
  ...
  `fecha_actualizacion` timestamp NULL DEFAULT NULL,
  `registro_activo` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene las configuraciones del sistema';
...
CREATE TABLE IF NOT EXISTS `direcciones` (
  ...
  `fecha_actualizacion` timestamp NULL DEFAULT NULL,
  `registro_activo` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene las direcciones por persona.';
...
CREATE TABLE IF NOT EXISTS `escala_ingresos` (
  ...
  `fecha_actualizacion` timestamp NULL DEFAULT NULL,
  `registro_activo` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Tabla que indica la escala de ingresos de un empleado';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene los datos de las escuelas';
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene los datos de los estudiantes';
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene los datos de los grados';
...
CREATE TABLE IF NOT EXISTS `grado_escuela` (
  ...
  `id_escuela` int(11) NOT NULL,
  `id_seccion` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene los grados asociados a cada escuela';
...
CREATE TABLE IF NOT EXISTS `jornadas` (
  ...
  `fecha_actualizacion` timestamp NULL DEFAULT NULL,
  `registro_activo` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene las jornadas laborales';
...
CREATE TABLE IF NOT EXISTS `medio_transporte` (
  ...
  `fecha_actualizacion` timestamp NULL DEFAULT NULL,
  `registro_activo` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene los medios en los que se transporta el al';
...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene los datos de las personas';
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene los datos de los representantes';
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene los datos de las secciones por grado';
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene los datos de los usuarios';
...
ALTER TABLE `censo`
  ...
  ADD UNIQUE KEY `id_censo_UNIQUE` (`id_censo`),
  ADD KEY `GradoACursar` (`GradoACursar`);

--
-- Indices de la tabla `censo_grados`
--
ALTER TABLE `censo_grados`
  ADD PRIMARY KEY (`id_censo_grado`),
...
ALTER TABLE `cupos`
  ...
  ADD KEY `escuelafk_idx` (`id_escuela`),
  ADD KEY `seccionfk_idx` (`id_seccion`),
  ADD KEY `gradosfk_idx` (`id_grado`);
...
ALTER TABLE `escuela_nivel_educativo`
  ADD PRIMARY KEY (`id_escuela_nivel_educativo`),
  ADD KEY `fk_escuela_idx` (`id_escuela`),
  ADD KEY `fk_nivel_educativo_idx` (`id_nivel_educativo`);

--
-- Indices de la tabla `escuela_nivel_educativo_grado`
--
ALTER TABLE `escuela_nivel_educativo_grado`
  ADD PRIMARY KEY (`id_escuela_nivel_educativo_grado`),
  ADD KEY `fk_grado_idx` (`id_grado`),
  ADD KEY `fk_escuela_nivel_educativo_idx` (`id_escuela_nivel_educativo`);
...
ALTER TABLE `estudiantes`
  ...
  ADD KEY `fk_estudiantes_representantes1_idx` (`id_representante`);
...
ALTER TABLE `puntaje_censo`
  ADD PRIMARY KEY (`id_puntaje_censo`),
  ADD KEY `fk_putaje_censo_idx` (`id_censo`);
...
ALTER TABLE `recaudo_estudiante`
  ADD PRIMARY KEY (`id_recaudo_estudiante`),
  ADD KEY `recaudo_estudiante_estudiante_idx` (`id_estudiante`),
  ADD KEY `recaudo_estudiante_recaudo_idx` (`id_recaudo`);
...
--
ALTER TABLE `cargo`
  MODIFY `cargo_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=140;
--
