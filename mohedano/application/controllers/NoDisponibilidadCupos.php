  ...
  class NoDisponibilidadCupos extends CI_Controller {
          ...
          public function index()
          {
                  ...
                  foreach ($censo as $row) {
                        ...
                        $email_message .= "Reciba un cordial saludo en nombre del equipo de la  Comunidad Educativa de la <b>".strtoupper($this->config->item('uem_name'))."</b>, por medio de la  presente hacemos de su conocimiento, que una vez realizado el proceso de inscripci&oacute;n  de los alumnos regulares y verificada la disponibilidad de cupo para el "
