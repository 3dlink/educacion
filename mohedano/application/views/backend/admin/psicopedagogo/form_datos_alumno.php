        ...
        <form id="form-datos-alumno" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="hidden" required class="form-control" id="FechaDeNacimientoDelAlumno" name="FechaDeNacimientoDelAlumno" placeholder="" value="">
                </div>
            </div>
            <div class="form-group">
                <label for="field-1" class="col-sm-4 control-label">Sexo<span style="color:red"> *</span></label>
                <div class="col-sm-6">
            ...
            <div id="sectorMunicipioChacaoAlumno" class="form-group" style="display: none">
                ...
                <div class="col-sm-6">
                      <select class="form-control" id="select-sector-municipio" name="UrbanizacionOSectorDondeResideElAlumno" >
                        <option value="0" selected="selected" disabled="disabled">Seleccione...</option>
