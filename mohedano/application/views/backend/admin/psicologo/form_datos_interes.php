    ...
    <div class="box-content">
        <form id="form-datos-otros" class="form-horizontal form-groups-bordered form-censo" accept-charset="utf-8">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="checkbox depenActividadEspe" style="display:none">
                      <label><input type="checkbox" class="requireActiEspecialAlu" name="aluActiDeportivaNinguna" value="1">Ninguna</label>
                    </div>
                    <div class="checkbox depenActividadEspe" style="display:none">
                      <label><input type="checkbox" class="requireActiEspecialAlu" name="aluActiDeportiva" value="1">Deportiva</label>
                    </div>
                    <div class="checkbox depenActividadEspe" style="display:none">
                      <label><input type="checkbox" class="requireActiEspecialAlu" name="aluActiAcademica" value="1">Académica</label>
                    </div>
                    <div class="checkbox depenActividadEspe" style="display:none">
                      <label><input type="checkbox" class="requireActiEspecialAlu" name="aluActiCultural" value="1">Cultural</label>
                    </div>
                    <div class="checkbox depenActividadEspe" style="display:none">
                      <label><input type="checkbox" class="requireActiEspecialAlu" name="aluActiOtra" value="1">Otras</label>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2"></div>
                <div class="col-sm-4">
                    <button type="button" id="siguiente-datos-interes" class="btn btn-info">Enviar censo</button>
                </div>
            </div>
        </form>
    </div>
