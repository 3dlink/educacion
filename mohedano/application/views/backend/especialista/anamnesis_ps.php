<div class="row">
    <div class="col-md-12">
        ...
        <div class="tab-content">
            <?php include 'psicologo/form_datos_alumno.php';?>
            <?php include 'psicologo/form_datos_representante.php';?>
            <?php include 'psicologo/form_datos_familia.php';?>
            <?php include 'psicologo/form_datos_ambiente.php';?>
            <?php include 'psicologo/form_datos_socioeconomicos.php';?>
            <?php include 'psicologo/form_datos_escolar.php';?>
            <?php include 'psicologo/form_datos_salud.php';?>
        </div>
    </div>
</div>
