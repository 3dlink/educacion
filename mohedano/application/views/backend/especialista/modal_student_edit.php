...
<div class="row">
    <div class="col-sm-12">
        <div class="wrapperRecaudos">
            <?php echo form_open(base_url() . 'admin/recaudos_validate' , array('class' => 'form-horizontal', 'id' => 'validarRecaudos' ,'enctype' => 'multipart/form-data', 'role' => 'form', 'target' => 'divTarget'));?>
