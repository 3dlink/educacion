                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    <!-- EDITING LINK -->
                                    <li>
                                        <a href="<?php echo base_url();?>especialista/census_edit/edit/<?php echo $id_censo; ?>" >
                                    ...
                                    <!-- PLANILLA LINK -->
                                    <li class="divider"></li>
                                    <?php $base_url = base_url().'modal/popup/modal_census_student_edit/'; ?>
                                    <?php $cedula_identidad = $row['cedula_identidad']; ?>
                                    <li>
                                        <a href="javascript:;" onclick="showAjaxModal('<?php echo $base_url.$id_censo;?>');">
                                            <i class="entypo-check"></i>
                                                <?php echo "Ver Planilla"?>
                                            </a>
                                    </li>
                                    <!-- ANAMNESIS LINK -->
                                    <li class="divider"></li>
                                    <?php
                                        if($this->session->userdata('especialist') == "PSICOLOGO"){
                                            $base_url = 'anamnesis_ps';
                                        }
                                        if($this->session->userdata('especialist') == "PSICOPEDAGOGO"){
                                            $base_url = 'anamnesis_psc';
                                        }
                                        if($this->session->userdata('especialist') == "TRABAJO_SOCIAL"){
                                            $base_url = 'anamnesis_ts';
                                        }
                                    ?>
                                    <li>
                                        <a href="<?php echo
                                            ($row['id_especialista'] == 0) ? $base_url.'/create/'.$id_censo : $base_url.'/edit/'.$id_censo ;?>" >
                                            <i class="entypo-pencil"></i>
                                            <?php echo ($row['id_especialista'] == 0) ? "Realizar Anamnesis" : "Editar Anamnesis" ?>
                                        </a>
                                    </li>
