            ...
            <div class="tab-pane box active" id="add" style="padding: 5px">
                <div class="box-content">
                    ...
                    <div class="form-group oculto" id="selectConstancias">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" name="record_types" id="record_types" required >
                                ...
                                <!-- <option value="4">Constancia de Promoción</option> -->
                                <option value="2">Constancia de Asistencia</option>
                                <option value="7">Constancia de Tramitación de Documentos</option>
                                <option value="8">Convocatoria al Representante</option>
                                <!-- <option value="9">Constancia de Referencia Externa</option> -->
                            </select>
                        </div>
                        <div class="col-sm-3">
                            <a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_view_record_'+document.getElementById('record_types').options[document.getElementById('record_types').selectedIndex].value+'/'+document.getElementById('txtIdentification').value);" class="btn btn-primary oculto" id='linkConstancia'>
                    ...
                    <div class="form-group oculto" id="linkConstanciaAsistencia">
                        ...
                        <div class="col-sm-3">
                            <a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_view_record_'+document.getElementById('record_types').options[document.getElementById('record_types').selectedIndex].value+'/'+document.getElementById('txtIdentification').value+'/'+document.getElementById('txtFecha').value+'_'+document.getElementById('txtDesde').value+'_'+document.getElementById('txtHasta').value);" class="btn btn-primary oculto" id='linkConstanciaAsistenciaButton'>
                                <i class="entypo-export"></i>
                                Ver Constancia
                            </a>
                        </div>
                    ...
                    <div class="form-group oculto" id="linkConstanciaTramites">
                        ...
                        <div class="col-sm-3">
                            <a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_view_record_'+document.getElementById('record_types').options[document.getElementById('record_types').selectedIndex].value+'/'+document.getElementById('txtIdentification').value+'/'+document.getElementById('txtTramite').value);" class="btn btn-primary oculto" id='linkConstanciaTramitesButton'>
                                <i class="entypo-export"></i>
                                Ver Constancia
                            </a>
                        </div>
                    ...
                    <div class="form-group oculto" id="linkConstanciaConvovatoria">
                        ...
                        <div class="col-sm-3">
                            <a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_view_record_'+document.getElementById('record_types').options[document.getElementById('record_types').selectedIndex].value+'/'+document.getElementById('txtIdentification').value+'/'+document.getElementById('txtFechaConvocatoria').value+'_'+document.getElementById('txtHora').value+'_'+document.getElementById('txtAtendido').value);" class="btn btn-primary oculto" id='linkConstanciaConvovatoriaButton'>
                                <i class="entypo-export"></i>
                                Ver Constancia
                            </a>
                        </div>
