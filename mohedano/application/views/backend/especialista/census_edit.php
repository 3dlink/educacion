<div style="margin-top: 30px; margin-bottom: 5px;" class="col-md-12 ">
    <button type="button" class="btn btn-primary" style="margin-right: 15px;" id="btnSaveMainDos">
        <i class="entypo-inbox"></i><?php echo " Guardar Datos";?>
    </button>
    <a href="javascript:;" onclick="validate_modal('<?php echo base_url();?>especialista/census_edit/validate/<?php echo $id_censo_selected; ?>');"
        class="btn btn-success" style="margin-right: 15px;" id="btnValidateMain">
        <i class="entypo-check"></i><?php echo " Validar Información";?>
    </a>
</div>
