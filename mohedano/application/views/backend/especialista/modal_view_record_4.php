        ...
        <div class="form-group">
            <div class="col-sm-12" id="study-record" style="text-align: center; ">
                <div class="title-record" style="margin:50px auto 40px;">
                    <strong><h4>CONSTANCIAS DE INSCRIPCIÓN</h4></strong>
                </div>
                <div style="text-align: justify;">
                    <p style="font-size: 11px !important; line-height: 200%;">
                         Quien suscribe, <?php echo $escuela->director->primer_nombre.' '.$escuela->director->segundo_nombre.', '.$escuela->director->primer_apellido.' '.$escuela->director->segundo_apellido; ?>,  C.I:<?php echo $escuela->director->cedula_identidad; ?> Director (a), de la U.E.M. Andrés Bello hace constar por medio de la presente que el alumno (a) <?php echo $estudiante[0]->persona->primer_nombre.' '.$estudiante[0]->persona->segundo_nombre.', '.$estudiante[0]->persona->primer_apellido.' '.$estudiante[0]->persona->segundo_apellido; ?>  titular de la Cédula de Identidad y/o Cédula Escolar N°: <?php echo $cedula_estudiante; ?>,  cursará estudios en esta Unidad Educativa, en el <?php echo $estudiante[0]->grado->abreviacion_grado; ?> grado/año, <?php echo $estudiante[0]->seccion->nombre_seccion;; ?>,  correspondiente al Año Escolar  <?php echo $ano_escolar; ?>. 
                    </p>
