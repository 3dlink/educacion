				...
				<form id="formCensusEdit" class="form-horizontal form-groups-bordered" accept-charset="utf-8">
				        ...
				        <div class="form-group">
				            <div class="col-sm-offset-5 col-sm-5">
				                <button type="button" id="btnAsignarEscuela" class="btn btn-primary" >Aprobar Cupo</button>
				            </div>
				        </div>
				    </form>
			    </div>
...
<script src="<?php echo base_url(); ?>assets/js/censo/modal_student_aprobe.js"></script>